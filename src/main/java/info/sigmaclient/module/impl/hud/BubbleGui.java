...
public class BubbleGui extends Module {
    ...
    public void onEvent(Event event) {
        ...
        if (event instanceof EventRenderGui) {
            ...
            rot = modRot;
            if (inModules) {
                Color[] color = new Color[Objects.requireNonNull(getModules(ModuleData.Type.values()[currentType])).size()];
                int currentModVal = 0;
                for (Module mod : Objects.requireNonNull(getModules(ModuleData.Type.values()[currentType]))) {
