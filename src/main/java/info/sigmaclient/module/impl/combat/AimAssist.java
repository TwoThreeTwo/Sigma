...
public class AimAssist extends Module {
    ...
    private void stepAngle() {
        ...
        float targetYaw = RotationUtils.getYawChange(target.posX + randomNumber() * xz, target.posZ + randomNumber() * xz);
        ...
        float targetPitch = RotationUtils.getPitchChange(target, target.posY + randomNumber() * y);
