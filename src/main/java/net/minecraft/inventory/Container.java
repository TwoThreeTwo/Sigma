...
public abstract class Container {
    ...
    /**
     * Extracts the drag mode. Args : eventButton. Return (0 : evenly split, 1 :
     * one item by slot, 2 : not used ?)
     */
    ...
    /**
     * Args : clickedButton, Returns (0 : start drag, 1 : add slot, 2 : end
     * drag)
     */
    ...
    /**
     * Like the version that takes an inventory. If the given TileEntity is not
     * an Inventory, 0 is returned instead.
     */
    ...
    /**
     * Handles slot click. Args : slotId, clickedButton, mode (0 = basic click,
     * 1 = shift click, 2 = Hotbar, 3 = pickBlock, 4 = Drop, 5 = ?, 6 = Double
     * click), player
     */
    public ItemStack slotClick(int slotId, int clickedButton, int mode, EntityPlayer playerIn) {
        ...
        if (mode == 5) {
            int var7 = dragEvent;
            dragEvent = Container.getDragEvent(clickedButton);
            ...
            if ((var7 != 1 || dragEvent != 2) && var7 != dragEvent) {
                ...
                dragMode = Container.extractDragMode(clickedButton);

                if (Container.func_180610_a(dragMode, playerIn)) {
                    dragEvent = 1;
                    dragSlots.clear();
                } else {
                    resetDrag();
                ...
                if (var8 != null && Container.canAddItemToSlot(var8, var6.getItemStack(), true) && var8.isItemValid(var6.getItemStack()) && var6.getItemStack().stackSize > dragSlots.size() && canDragIntoSlot(var8)) {
                    dragSlots.add(var8);
                }
            } else if (dragEvent == 2) {
                if (!dragSlots.isEmpty()) {
                    ...
                    while (var10.hasNext()) {
                        ...
                        if (var11 != null && Container.canAddItemToSlot(var11, var6.getItemStack(), true) && var11.isItemValid(var6.getItemStack()) && var6.getItemStack().stackSize >= dragSlots.size() && canDragIntoSlot(var11)) {
                            ItemStack var12 = var17.copy();
                            int var13 = var11.getHasStack() ? var11.getStack().stackSize : 0;
                            Container.computeStackSize(dragSlots, dragMode, var12, var13);
            ...
            if ((mode == 0 || mode == 1) && (clickedButton == 0 || clickedButton == 1)) {
                if (slotId == -999) {
                    ...
                    var16 = (Slot) inventorySlots.get(slotId);

                    if (var16 != null && var16.canTakeStack(playerIn)) {
                        var17 = transferStackInSlot(playerIn, slotId);
                ...
                if (var17 != null && (var16 == null || !var16.getHasStack() || !var16.canTakeStack(playerIn))) {
                    var9 = clickedButton == 0 ? 0 : inventorySlots.size() - 1;
                    var21 = clickedButton == 0 ? 1 : -1;

                    for (int var22 = 0; var22 < 2; ++var22) {
                        for (int var24 = var9; var24 >= 0 && var24 < inventorySlots.size() && var17.stackSize < var17.getMaxStackSize(); var24 += var21) {
                            Slot var25 = (Slot) inventorySlots.get(var24);

                            if (var25.getHasStack() && Container.canAddItemToSlot(var25, var17, true) && var25.canTakeStack(playerIn) && func_94530_a(var17, var25) && (var22 != 0 || var25.getStack().stackSize != var25.getStack().getMaxStackSize())) {
