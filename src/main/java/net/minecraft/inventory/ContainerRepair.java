...
public class ContainerRepair extends Container {
    ...
    public ContainerRepair(InventoryPlayer p_i45807_1_, final World worldIn, final BlockPos p_i45807_3_, EntityPlayer p_i45807_4_) {
        ...
        addSlotToContainer(new Slot(outputSlot, 2, 134, 47) {
            ...
            public boolean canTakeStack(EntityPlayer p_82869_1_) {
                return (p_82869_1_.capabilities.isCreativeMode || p_82869_1_.experienceLevel >= maximumCost) && maximumCost > 0 && getHasStack();
            }
            ...
            public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack) {
                ...
                if (materialCost > 0) {
                    ...
                    if (var3 != null && var3.stackSize > materialCost) {
                        var3.stackSize -= materialCost;
    ...
    public boolean canInteractWith(EntityPlayer playerIn) {
        return theWorld.getBlockState(field_178156_j).getBlock() != Blocks.anvil ? false : playerIn.getDistanceSq(field_178156_j.getX() + 0.5D, field_178156_j.getY() + 0.5D, field_178156_j.getZ() + 0.5D) <= 64.0D;
    }
