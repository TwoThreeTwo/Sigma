...
public abstract class WorldProvider {
    ...
    public IChunkProvider createChunkGenerator() {
        return terrainType == WorldType.FLAT ? new ChunkProviderFlat(worldObj, worldObj.getSeed(), worldObj.getWorldInfo().isMapFeaturesEnabled(), generatorSettings) : (terrainType == WorldType.DEBUG_WORLD ? new ChunkProviderDebug(worldObj) : (terrainType == WorldType.CUSTOMIZED ? new ChunkProviderGenerate(worldObj, worldObj.getSeed(), worldObj.getWorldInfo().isMapFeaturesEnabled(), generatorSettings) : new ChunkProviderGenerate(worldObj, worldObj.getSeed(), worldObj.getWorldInfo().isMapFeaturesEnabled(), generatorSettings)));
    }
