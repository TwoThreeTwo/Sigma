...
public class Teleporter {
    ...
    public void func_180266_a(Entity p_180266_1_, float p_180266_2_) {
        if (worldServerInstance.provider.getDimensionId() != 1) {
            if (!func_180620_b(p_180266_1_, p_180266_2_)) {
                makePortal(p_180266_1_);
                func_180620_b(p_180266_1_, p_180266_2_);
            }
        } else {
            ...
            for (int var8 = -2; var8 <= 2; ++var8) {
                for (int var9 = -2; var9 <= 2; ++var9) {
                    for (int var10 = -1; var10 < 3; ++var10) {
                        ...
                        worldServerInstance.setBlockState(new BlockPos(var11, var12, var13), var14 ? Blocks.obsidian.getDefaultState() : Blocks.air.getDefaultState());
                    }
                }
            }
    ...
    public boolean func_180620_b(Entity p_180620_1_, float p_180620_2_) {
        ...
        if (destinationCoordinateCache.containsItem(var10)) {
            Teleporter.PortalPosition var12 = (Teleporter.PortalPosition) destinationCoordinateCache.getValueByKey(var10);
            var4 = 0.0D;
            var9 = var12;
            var12.lastUpdateTime = worldServerInstance.getTotalWorldTime();
            var8 = false;
        } else {
            ...
            for (int var13 = -128; var13 <= 128; ++var13) {
                ...
                for (int var14 = -128; var14 <= 128; ++var14) {
                    for (BlockPos var15 = var34.add(var13, worldServerInstance.getActualHeight() - 1 - var34.getY(), var14); var15.getY() >= 0; var15 = var16) {
                        var16 = var15.offsetDown();

                        if (worldServerInstance.getBlockState(var15).getBlock() == Blocks.portal) {
                            while (worldServerInstance.getBlockState(var16 = var15.offsetDown()).getBlock() == Blocks.portal) {
                                var15 = var16;
                            }
        ...
        if (var4 >= 0.0D) {
            if (var8) {
                destinationCoordinateCache.add(var10, new Teleporter.PortalPosition((BlockPos) var9, worldServerInstance.getTotalWorldTime()));
                destinationCoordinateKeys.add(Long.valueOf(var10));
            }
            ...
            if (worldServerInstance.getBlockState(((BlockPos) var9).offsetWest()).getBlock() == Blocks.portal) {
                var18 = EnumFacing.NORTH;
            }

            if (worldServerInstance.getBlockState(((BlockPos) var9).offsetEast()).getBlock() == Blocks.portal) {
                var18 = EnumFacing.SOUTH;
            }

            if (worldServerInstance.getBlockState(((BlockPos) var9).offsetNorth()).getBlock() == Blocks.portal) {
                var18 = EnumFacing.EAST;
            }

            if (worldServerInstance.getBlockState(((BlockPos) var9).offsetSouth()).getBlock() == Blocks.portal) {
            ...
            if (var18 != null) {
                ...
                boolean var22 = func_180265_a(var21);
                boolean var23 = func_180265_a(var21.offset(var20));
                ...
                if (var23 && var22) {
                    ...
                    var22 = func_180265_a(var24);
                    var23 = func_180265_a(var24.offset(var20));
                }
                ...
                p_180620_1_.motionX = var30 * var26 + var32 * var29;
                p_180620_1_.motionZ = var30 * var28 + var32 * var27;
                p_180620_1_.rotationYaw = p_180620_2_ - var19.getHorizontalIndex() * 90 + var18.getHorizontalIndex() * 90;
            } else {
    ...
    private boolean func_180265_a(BlockPos p_180265_1_) {
        return !worldServerInstance.isAirBlock(p_180265_1_) || !worldServerInstance.isAirBlock(p_180265_1_.offsetUp());
    }
    ...
    public boolean makePortal(Entity p_85188_1_) {
        ...
        for (var13 = var5 - var2; var13 <= var5 + var2; ++var13) {
            ...
            for (var16 = var7 - var2; var16 <= var7 + var2; ++var16) {
                ...
                for (var19 = worldServerInstance.getActualHeight() - 1; var19 >= 0; --var19) {
                    if (worldServerInstance.isAirBlock(new BlockPos(var13, var19, var16))) {
                        while (var19 > 0 && worldServerInstance.isAirBlock(new BlockPos(var13, var19 - 1, var16))) {
                            --var19;
                        }
                            ...
                            for (var23 = 0; var23 < 3; ++var23) {
                                for (var24 = 0; var24 < 4; ++var24) {
                                    for (var25 = -1; var25 < 4; ++var25) {
                                        ...
                                        if (var25 < 0 && !worldServerInstance.getBlockState(new BlockPos(var26, var27, var28)).getBlock().getMaterial().isSolid() || var25 >= 0 && !worldServerInstance.isAirBlock(new BlockPos(var26, var27, var28))) {
                                            continue label271;
                                        }
                                    }
                                }
                            ...
                            for (var20 = var12; var20 < var12 + 2; ++var20) {
                                ...
                                for (var23 = 0; var23 < 4; ++var23) {
                                    for (var24 = -1; var24 < 4; ++var24) {
                                        ...
                                        if (var24 < 0 && !worldServerInstance.getBlockState(new BlockPos(var25, var26, var27)).getBlock().getMaterial().isSolid() || var24 >= 0 && !worldServerInstance.isAirBlock(new BlockPos(var25, var26, var27))) {
                                            continue label219;
                                        }
                                    }
                                }
        ...
        if (var3 < 0.0D) {
            var9 = MathHelper.clamp_int(var9, 70, worldServerInstance.getActualHeight() - 10);
            var15 = var9;
            ...
            for (var19 = -1; var19 <= 1; ++var19) {
                for (var20 = 1; var20 < 3; ++var20) {
                    for (var21 = -1; var21 < 3; ++var21) {
                        ...
                        worldServerInstance.setBlockState(new BlockPos(var22, var23, var24), var34 ? Blocks.obsidian.getDefaultState() : Blocks.air.getDefaultState());
                    }
                }
            }
        }
        ...
        for (var20 = 0; var20 < 4; ++var20) {
            for (var21 = 0; var21 < 4; ++var21) {
                for (var22 = -1; var22 < 4; ++var22) {
                    ...
                    worldServerInstance.setBlockState(new BlockPos(var23, var24, var25), var35 ? Blocks.obsidian.getDefaultState() : var31, 2);
                }
            }
            ...
            for (var21 = 0; var21 < 4; ++var21) {
                for (var22 = -1; var22 < 4; ++var22) {
                    ...
                    var24 = var15 + var22;
                    var25 = var16 + (var21 - 1) * var18;
                    worldServerInstance.notifyNeighborsOfStateChange(new BlockPos(var23, var24, var25), worldServerInstance.getBlockState(new BlockPos(var23, var24, var25)).getBlock());
                }
            }
        }
