        ...
        if (!p_77192_2_ && !p_77192_3_) {
            ...
            for (int var39 = 0; var39 < var9; ++var39) {
                ...
                if ((!var40.getPeacefulCreature() || p_77192_3_) && (var40.getPeacefulCreature() || p_77192_2_) && (!var40.getAnimal() || p_77192_4_)) {
                    ...
                    int var41 = var40.getMaxNumberOfCreature() * var5 / SpawnerAnimals.field_180268_a;
                                        ...
                                        if (var29 < 4) {
                                            label108:
                                            {
                                                ...
                                                if (!p_77192_1_.func_175636_b(var31, var24, var32, 24.0D) && var37.distanceSq(var31, var24, var32) >= 576.0D) {
                                                    ...
                                                    if (p_77192_1_.func_175732_a(var40, var27, var30) && SpawnerAnimals.func_180267_a(EntitySpawnPlacementRegistry.func_180109_a(var27.entityClass), p_77192_1_, var30)) {
                                                        EntityLiving var33;
