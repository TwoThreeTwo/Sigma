...
public class StatList {
    ...
    private static void initCraftableStats() {
        ...
        while (var1.hasNext()) {
            ...
            if (var6 != null) {
                ...
                if (var4 != null) {
                    StatList.objectCraftStats[var3] = (new StatCrafting("stat.craftItem.", var4, new ChatComponentTranslation("stat.craftItem", new Object[]{(new ItemStack(var6)).getChatComponent()}), var6)).registerStat();
                }
            }
        }

        StatList.replaceAllSimilarBlocks(StatList.objectCraftStats);
    }
        ...
        while (var0.hasNext()) {
            ...
            if (var2 != null) {
                ...
                if (var4 != null && var1.getEnableStats()) {
                    StatList.mineBlockStatArray[var3] = (new StatCrafting("stat.mineBlock.", var4, new ChatComponentTranslation("stat.mineBlock", new Object[]{(new ItemStack(var1)).getChatComponent()}), var2)).registerStat();
                    StatList.objectMineStats.add(StatList.mineBlockStatArray[var3]);
                }
            }
        }

        StatList.replaceAllSimilarBlocks(StatList.mineBlockStatArray);
    }
    ...
    private static void initStats() {
        ...
        while (var0.hasNext()) {
            ...
            if (var1 != null) {
                ...
                if (var3 != null) {
                    StatList.objectUseStats[var2] = (new StatCrafting("stat.useItem.", var3, new ChatComponentTranslation("stat.useItem", new Object[]{(new ItemStack(var1)).getChatComponent()}), var1)).registerStat();

                    if (!(var1 instanceof ItemBlock)) {
                        StatList.itemStats.add(StatList.objectUseStats[var2]);
                    }
                }
            }
        }

        StatList.replaceAllSimilarBlocks(StatList.objectUseStats);
    }
        ...
        while (var0.hasNext()) {
            ...
            if (var1 != null) {
                ...
                if (var3 != null && var1.isDamageable()) {
                    StatList.objectBreakStats[var2] = (new StatCrafting("stat.breakItem.", var3, new ChatComponentTranslation("stat.breakItem", new Object[]{(new ItemStack(var1)).getChatComponent()}), var1)).registerStat();
                }
            }
        }

        StatList.replaceAllSimilarBlocks(StatList.objectBreakStats);
    }
    ...
    public static StatBase getOneShotStat(String p_151177_0_) {
        return (StatBase) StatList.oneShotStats.get(p_151177_0_);
    }
}
