...
public class CrashReportCategory {
    ...
    public static String getCoordinateInfo(double x, double y, double z) {
        return String.format("%.2f,%.2f,%.2f - %s", new Object[]{Double.valueOf(x), Double.valueOf(y), Double.valueOf(z), CrashReportCategory.getCoordinateInfo(new BlockPos(x, y, z))});
    }
    ...
    public void trimStackTraceEntriesFromBottom(int amount) {
        StackTraceElement[] var2 = new StackTraceElement[stackTrace.length - amount];
