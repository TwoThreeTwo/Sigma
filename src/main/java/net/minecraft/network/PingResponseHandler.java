...
public class PingResponseHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext p_channelRead_1_, Object p_channelRead_2_) {
        ...
        try {
            ...
            MinecraftServer var6 = networkSystem.getServer();
            int var7 = var3.readableBytes();
            String var8;

            switch (var7) {
                case 0:
                    PingResponseHandler.logger.debug("Ping: (<1.3.x) from {}:{}", new Object[]{var5.getAddress(), Integer.valueOf(var5.getPort())});
                    ...
                    writeAndFlush(p_channelRead_1_, getStringBuffer(var8));
                    break;
                ...
                case 1:
                    ...
                    PingResponseHandler.logger.debug("Ping: (1.4-1.5.x) from {}:{}", new Object[]{var5.getAddress(), Integer.valueOf(var5.getPort())});
                ...
                default:
                    ...
                    PingResponseHandler.logger.debug("Ping: (1.6) from {}:{}", new Object[]{var5.getAddress(), Integer.valueOf(var5.getPort())});
                    ...
                    ByteBuf var11 = getStringBuffer(var10);

                    try {
                        writeAndFlush(p_channelRead_1_, var11);
                    } finally {
                        var11.release();
                    }
            }
