...
public class VillageCollection extends WorldSavedData {
    ...
    public Village func_176056_a(BlockPos p_176056_1_, int p_176056_2_) {
        ...
        Iterator var6 = villageList.iterator();
        ...
        while (var6.hasNext()) {
            ...
            if (var8 < var4) {
                float var10 = p_176056_2_ + var7.getVillageRadius();
            ...
            for (int var6 = -var3; var6 < var3; ++var6) {
                for (int var7 = -var4; var7 < var4; ++var7) {
                    ...
                    if (func_176058_f(var8)) {
                        VillageDoorInfo var9 = func_176055_c(var8);
    ...
    private void func_176059_d(BlockPos p_176059_1_) {
        EnumFacing var2 = BlockDoor.func_176517_h(worldObj, p_176059_1_);
        EnumFacing var3 = var2.getOpposite();
        int var4 = func_176061_a(p_176059_1_, var2, 5);
        int var5 = func_176061_a(p_176059_1_, var3, var4 + 1);
    ...
    private boolean func_176058_f(BlockPos p_176058_1_) {
        Block var2 = worldObj.getBlockState(p_176058_1_).getBlock();
