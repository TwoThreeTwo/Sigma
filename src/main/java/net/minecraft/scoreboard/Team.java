...
public abstract class Team {
    ...
    public static enum EnumVisible {
        ALWAYS("ALWAYS", 0, "always", 0), NEVER("NEVER", 1, "never", 1), HIDE_FOR_OTHER_TEAMS("HIDE_FOR_OTHER_TEAMS", 2, "hideForOtherTeams", 2), HIDE_FOR_OWN_TEAM("HIDE_FOR_OWN_TEAM", 3, "hideForOwnTeam", 3);
        ...
        static {
            Team.EnumVisible[] var0 = EnumVisible.values();
            int var1 = var0.length;

            for (int var2 = 0; var2 < var1; ++var2) {
                Team.EnumVisible var3 = var0[var2];
                EnumVisible.field_178828_g.put(var3.field_178830_e, var3);
            }
        }
        ...
        public static Team.EnumVisible func_178824_a(String p_178824_0_) {
            return (Team.EnumVisible) EnumVisible.field_178828_g.get(p_178824_0_);
        }
    }
}
