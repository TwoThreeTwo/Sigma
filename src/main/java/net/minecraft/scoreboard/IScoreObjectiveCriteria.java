...
public interface IScoreObjectiveCriteria {
    ...
    public static enum EnumRenderType {
        ...
        static {
            IScoreObjectiveCriteria.EnumRenderType[] var0 = EnumRenderType.values();
            int var1 = var0.length;

            for (int var2 = 0; var2 < var1; ++var2) {
                IScoreObjectiveCriteria.EnumRenderType var3 = var0[var2];
                EnumRenderType.field_178801_c.put(var3.func_178796_a(), var3);
            }
        }
        ...
        public static IScoreObjectiveCriteria.EnumRenderType func_178795_a(String p_178795_0_) {
            IScoreObjectiveCriteria.EnumRenderType var1 = (IScoreObjectiveCriteria.EnumRenderType) EnumRenderType.field_178801_c.get(p_178795_0_);
