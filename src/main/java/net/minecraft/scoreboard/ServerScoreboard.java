...
public class ServerScoreboard extends Scoreboard {
    ...
    public void setObjectiveInDisplaySlot(int p_96530_1_, ScoreObjective p_96530_2_) {
        ScoreObjective var3 = getObjectiveInDisplaySlot(p_96530_1_);
    ...
    public boolean func_151392_a(String p_151392_1_, String p_151392_2_) {
        if (super.func_151392_a(p_151392_1_, p_151392_2_)) {
            ScorePlayerTeam var3 = getTeam(p_151392_2_);
            scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers(new S3EPacketTeams(var3, Arrays.asList(new String[]{p_151392_1_}), 3));
            func_96551_b();
            return true;
        } else {
            return false;
    ...
    public void removePlayerFromTeam(String p_96512_1_, ScorePlayerTeam p_96512_2_) {
        ...
        scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers(new S3EPacketTeams(p_96512_2_, Arrays.asList(new String[]{p_96512_1_}), 4));
        func_96551_b();
    }
    ...
    public List func_96550_d(ScoreObjective p_96550_1_) {
        ...
        Iterator var5 = getSortedScores(p_96550_1_).iterator();
    ...
    public void func_96549_e(ScoreObjective p_96549_1_) {
        ...
        Iterator var3 = scoreboardMCServer.getConfigurationManager().playerEntityList.iterator();
