...
public class ScoreboardSaveData extends WorldSavedData {
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        if (theScoreboard == null) {
            ...
            func_96501_b(nbt.getTagList("Objectives", 10));
            func_96500_c(nbt.getTagList("PlayerScores", 10));

            if (nbt.hasKey("DisplaySlots", 10)) {
                func_96504_c(nbt.getCompoundTag("DisplaySlots"));
            }

            if (nbt.hasKey("Teams", 9)) {
                func_96498_a(nbt.getTagList("Teams", 10));
            }
        }
    }
    ...
    protected void func_96498_a(NBTTagList p_96498_1_) {
        for (int var2 = 0; var2 < p_96498_1_.tagCount(); ++var2) {
            ...
            ScorePlayerTeam var4 = theScoreboard.createTeam(var3.getString("Name"));
            ...
            func_96502_a(var4, var3.getTagList("Players", 8));
        }
    }

    protected void func_96502_a(ScorePlayerTeam p_96502_1_, NBTTagList p_96502_2_) {
        for (int var3 = 0; var3 < p_96502_2_.tagCount(); ++var3) {
            theScoreboard.func_151392_a(p_96502_2_.getStringTagAt(var3), p_96502_1_.getRegisteredName());
        }
    }
    ...
    protected void func_96504_c(NBTTagCompound p_96504_1_) {
        for (int var2 = 0; var2 < 19; ++var2) {
            if (p_96504_1_.hasKey("slot_" + var2, 8)) {
                ...
                ScoreObjective var4 = theScoreboard.getObjective(var3);
                theScoreboard.setObjectiveInDisplaySlot(var2, var4);
            }
        }
    }
    ...
    protected void func_96501_b(NBTTagList p_96501_1_) {
        for (int var2 = 0; var2 < p_96501_1_.tagCount(); ++var2) {
            ...
            if (var4 != null) {
                ScoreObjective var5 = theScoreboard.addScoreObjective(var3.getString("Name"), var4);
    ...
    protected void func_96500_c(NBTTagList p_96500_1_) {
        for (int var2 = 0; var2 < p_96500_1_.tagCount(); ++var2) {
            ...
            ScoreObjective var4 = theScoreboard.getObjective(var3.getString("Objective"));
            Score var5 = theScoreboard.getValueFromObjective(var3.getString("Name"), var4);
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        if (theScoreboard == null) {
            ...
            nbt.setTag("Objectives", func_96505_b());
            nbt.setTag("PlayerScores", func_96503_e());
    ...
    protected NBTTagList func_96496_a() {
        ...
        Collection var2 = theScoreboard.getTeams();
    ...
    protected void func_96497_d(NBTTagCompound p_96497_1_) {
        ...
        for (int var4 = 0; var4 < 19; ++var4) {
            ScoreObjective var5 = theScoreboard.getObjectiveInDisplaySlot(var4);
    ...
    protected NBTTagList func_96505_b() {
        NBTTagList var1 = new NBTTagList();
        Collection var2 = theScoreboard.getScoreObjectives();
        Iterator var3 = var2.iterator();
    ...
    protected NBTTagList func_96503_e() {
        NBTTagList var1 = new NBTTagList();
        Collection var2 = theScoreboard.func_96528_e();
        Iterator var3 = var2.iterator();
