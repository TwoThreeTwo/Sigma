...
public class Scoreboard {
    ...
    public static String[] func_178821_h() {
        if (Scoreboard.field_178823_g == null) {
            ...
            for (int var0 = 0; var0 < 19; ++var0) {
                Scoreboard.field_178823_g[var0] = Scoreboard.getObjectiveDisplaySlot(var0);
            }
        }
    ...
    public Collection func_96520_a(IScoreObjectiveCriteria p_96520_1_) {
        Collection var2 = (Collection) scoreObjectiveCriterias.get(p_96520_1_);
    ...
    public boolean func_178819_b(String p_178819_1_, ScoreObjective p_178819_2_) {
        Map var3 = (Map) field_96544_c.get(p_178819_1_);
    ...
    public void func_178822_d(String p_178822_1_, ScoreObjective p_178822_2_) {
        ...
        if (p_178822_2_ == null) {
            ...
            if (var3 != null) {
                ...
                if (var3.size() < 1) {
                    Map var5 = (Map) field_96544_c.remove(p_178822_1_);
    ...
    public void func_96519_k(ScoreObjective p_96519_1_) {
        ...
        List var5 = (List) scoreObjectiveCriterias.get(p_96519_1_.getCriteria());
