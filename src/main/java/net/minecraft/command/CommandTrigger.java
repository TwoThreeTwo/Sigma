...
public class CommandTrigger extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 3) {
            ...
            if (var5 != null && var5.getCriteria() == IScoreObjectiveCriteria.field_178791_c) {
                int var6 = CommandBase.parseInt(args[2]);
                ...
                if (!var8.func_178819_b(var3.getName(), var5)) {
                    ...
                    if (var7.func_178816_g()) {
                        ...
                        if (var3.theItemInWorldManager.isCreative()) {
                            CommandBase.notifyOperators(sender, this, "commands.trigger.success", new Object[]{args[0], args[1], args[2]});
                        }
                    }
                }
            } else {
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        if (args.length == 1) {
            ...
            return args.length == 2 ? CommandBase.getListOfStringsMatchingLastWord(args, new String[]{"add", "set"}) : null;
        }
    }
}
