...
public class CommandDebug extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 1) {
            ...
            if (args[0].equals("start")) {
                ...
                CommandBase.notifyOperators(sender, this, "commands.debug.stop", new Object[]{Float.valueOf(var6 / 1000.0F), Integer.valueOf(var8)});
    ...
    private String func_147204_b(long p_147204_1_, int p_147204_3_) {
        ...
        var4.append("// ");
        var4.append(CommandDebug.func_147203_d());
        var4.append("\n\n");
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length == 1 ? CommandBase.getListOfStringsMatchingLastWord(args, new String[]{"start", "stop"}) : null;
    }
}
