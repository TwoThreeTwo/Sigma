...
public class PlayerSelector {
    ...
    public static List func_179656_b(ICommandSender p_179656_0_, String p_179656_1_, Class p_179656_2_) {
        Matcher var3 = PlayerSelector.tokenPattern.matcher(p_179656_1_);
    ...
    private static List func_179663_a(Map p_179663_0_, String p_179663_1_) {
        ...
        if ((var3 == null || !p_179663_1_.equals("e")) && !var7) {
            if (var6) {
                var2.add(new Predicate() {
                    ...
                    public boolean apply(Object p_apply_1_) {
                        return func_179624_a((Entity) p_apply_1_);
                    }
                });
            }
        } else {
            ...
            var2.add(new Predicate() {
                ...
                @Override
                public boolean apply(Object p_apply_1_) {
                    return func_179613_a((Entity) p_apply_1_);
                }
            });
        }
    ...
    private static List func_179648_b(Map p_179648_0_) {
        ...
        if (var2 > -1 || var3 > -1) {
            var1.add(new Predicate() {
                ...
                @Override
                public boolean apply(Object p_apply_1_) {
                    return func_179625_a((Entity) p_apply_1_);
                }
            });
        }
    ...
    private static List func_179649_c(Map p_179649_0_) {
        ...
        if (var2 != WorldSettings.GameType.NOT_SET.getID()) {
            var1.add(new Predicate() {
                ...
                @Override
                public boolean apply(Object p_apply_1_) {
                    return func_179619_a((Entity) p_apply_1_);
                }
            });
        }
    ...
    private static List func_179659_d(Map p_179659_0_) {
        ...
        if (var2 != null) {
            ...
            var1.add(new Predicate() {
                ...
                @Override
                public boolean apply(Object p_apply_1_) {
                    return func_179621_a((Entity) p_apply_1_);
                }
            });
        }
    ...
    private static List func_179657_e(Map p_179657_0_) {
        ...
        if (var2 != null && var2.size() > 0) {
            var1.add(new Predicate() {
                ...
                @Override
                public boolean apply(Object p_apply_1_) {
                    return func_179603_a((Entity) p_apply_1_);
                }
            });
        }
    ...
    private static List func_179647_f(Map p_179647_0_) {
        ...
        if (var2 != null) {
            ...
            var1.add(new Predicate() {
                ...
                @Override
                public boolean apply(Object p_apply_1_) {
                    return func_179600_a((Entity) p_apply_1_);
                }
            });
        }
    ...
    private static List func_180698_a(Map p_180698_0_, final BlockPos p_180698_1_) {
        ...
        if (p_180698_1_ != null && (var3 >= 0 || var4 >= 0)) {
            ...
            var2.add(new Predicate() {
                ...
                @Override
                public boolean apply(Object p_apply_1_) {
                    return func_179594_a((Entity) p_apply_1_);
                }
            });
        }
    ...
    private static List func_179662_g(Map p_179662_0_) {
        ...
        if (p_179662_0_.containsKey("rym") || p_179662_0_.containsKey("ry")) {
            final int var2 = PlayerSelector.func_179650_a(PlayerSelector.func_179653_a(p_179662_0_, "rym", 0));
            final int var3 = PlayerSelector.func_179650_a(PlayerSelector.func_179653_a(p_179662_0_, "ry", 359));
            var1.add(new Predicate() {
                ...
                @Override
                public boolean apply(Object p_apply_1_) {
                    return func_179591_a((Entity) p_apply_1_);
                }
            });
        }

        if (p_179662_0_.containsKey("rxm") || p_179662_0_.containsKey("rx")) {
            final int var2 = PlayerSelector.func_179650_a(PlayerSelector.func_179653_a(p_179662_0_, "rxm", 0));
            final int var3 = PlayerSelector.func_179650_a(PlayerSelector.func_179653_a(p_179662_0_, "rx", 359));
            var1.add(new Predicate() {
                ...
                @Override
                public boolean apply(Object p_apply_1_) {
                    return func_179616_a((Entity) p_apply_1_);
                }
            });
        }
    ...
    private static List func_179660_a(Map p_179660_0_, Class p_179660_1_, List p_179660_2_, String p_179660_3_, World worldIn, BlockPos p_179660_5_) {
        ...
        if (p_179660_5_ != null) {
            ...
            if (!p_179660_0_.containsKey("dx") && !p_179660_0_.containsKey("dy") && !p_179660_0_.containsKey("dz")) {
                if (var13 >= 0) {
                    var19 = new AxisAlignedBB(p_179660_5_.getX() - var13, p_179660_5_.getY() - var13, p_179660_5_.getZ() - var13, p_179660_5_.getX() + var13 + 1, p_179660_5_.getY() + var13 + 1, p_179660_5_.getZ() + var13 + 1);
                ...
                var19 = PlayerSelector.func_179661_a(p_179660_5_, var10, var11, var12);
                ...
                if (var8 && var18 && !var9) {
                    Predicate var20 = new Predicate() {
                        ...
                        @Override
                        public boolean apply(Object p_apply_1_) {
                            return func_179609_a((Entity) p_apply_1_);
                        }
                    };
        ...
        if (!p_179658_4_.equals("p") && !p_179658_4_.equals("a") && !p_179658_4_.equals("e")) {
            ...
            Collections.sort(p_179658_0_, new Comparator() {
                ...
                public int compare(Object p_compare_1_, Object p_compare_2_) {
                    return func_179611_a((Entity) p_compare_1_, (Entity) p_compare_2_);
                }
            });
        }
    ...
    private static boolean func_179665_h(Map p_179665_0_) {
        Iterator var1 = PlayerSelector.field_179666_d.iterator();
        String var2;
    ...
    public static boolean matchesMultiplePlayers(String p_82377_0_) {
        Matcher var1 = PlayerSelector.tokenPattern.matcher(p_82377_0_);
    ...
    private static Map getArgumentMap(String p_82381_0_) {
        ...
        if (p_82381_0_ == null) {
            ...
            for (Matcher var4 = PlayerSelector.intListPattern.matcher(p_82381_0_); var4.find(); var3 = var4.end()) {
                String var5 = null;
            ...
            if (var3 < p_82381_0_.length()) {
                Matcher var6 = PlayerSelector.keyValueListPattern.matcher(var3 == -1 ? p_82381_0_ : p_82381_0_.substring(var3));
