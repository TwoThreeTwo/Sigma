...
public class CommandEnchant extends CommandBase {
        ...
        if (args.length < 2) {
            ...
            if (var13 == null) {
                ...
                if (var7 == null) {
                    ...
                    if (args.length >= 3) {
                        var5 = CommandBase.parseInt(args[2], var7.getMinLevel(), var7.getMaxLevel());
                    }
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length == 1 ? CommandBase.getListOfStringsMatchingLastWord(args, getListOfPlayers()) : (args.length == 2 ? CommandBase.getListOfStringsMatchingLastWord(args, Enchantment.func_180304_c()) : null);
    }
