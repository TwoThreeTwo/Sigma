...
public class CommandResultStats {
    ...
    public CommandResultStats() {
        field_179675_c = CommandResultStats.field_179674_b;
        field_179673_d = CommandResultStats.field_179674_b;
    }
    ...
    public void func_179672_a(ICommandSender p_179672_1_, CommandResultStats.Type p_179672_2_, int p_179672_3_) {
        String var4 = field_179675_c[p_179672_2_.func_179636_a()];
        ...
        if (var4 != null) {
            ...
            String var6 = field_179673_d[p_179672_2_.func_179636_a()];
    ...
    public void func_179670_b(NBTTagCompound p_179670_1_) {
        ...
        for (int var5 = 0; var5 < var4; ++var5) {
            CommandResultStats.Type var6 = var3[var5];
            String var7 = field_179675_c[var6.func_179636_a()];
            String var8 = field_179673_d[var6.func_179636_a()];
    ...
    public static enum Type {
        SUCCESS_COUNT("SUCCESS_COUNT", 0, 0, "SuccessCount"), AFFECTED_BLOCKS("AFFECTED_BLOCKS", 1, 1, "AffectedBlocks"), AFFECTED_ENTITIES("AFFECTED_ENTITIES", 2, 2, "AffectedEntities"), AFFECTED_ITEMS("AFFECTED_ITEMS", 3, 3, "AffectedItems"), QUERY_RESULT("QUERY_RESULT", 4, 4, "QueryResult");
        ...
        public static String[] func_179634_c() {
            ...
            int var1 = 0;
            CommandResultStats.Type[] var2 = Type.values();
            int var3 = var2.length;
        ...
        public static CommandResultStats.Type func_179635_a(String p_179635_0_) {
            CommandResultStats.Type[] var1 = Type.values();
