...
public class CommandExecuteAt extends CommandBase {
    ...
    public void processCommand(final ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 5) {
            ...
            final double var6 = CommandBase.func_175761_b(var3.posY, args[2], false);
            final double var8 = CommandBase.func_175761_b(var3.posZ, args[3], false);
            final BlockPos var10 = new BlockPos(var4, var6, var8);
            byte var11 = 4;

            if ("detect".equals(args[4]) && args.length > 10) {
                World var12 = sender.getEntityWorld();
                double var13 = CommandBase.func_175761_b(var4, args[5], false);
                double var15 = CommandBase.func_175761_b(var6, args[6], false);
                double var17 = CommandBase.func_175761_b(var8, args[7], false);
                Block var19 = CommandBase.getBlockByText(sender, args[8]);
                int var20 = CommandBase.parseInt(args[9], -1, 15);
            ...
            String var24 = CommandBase.func_180529_a(args, var11);
