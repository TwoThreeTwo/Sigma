...
public abstract class CommandBase implements ICommand {
    ...
    public static List func_175763_c(ICommandSender p_175763_0_, String p_175763_1_) throws EntityNotFoundException {
        return PlayerSelector.hasArguments(p_175763_1_) ? PlayerSelector.func_179656_b(p_175763_0_, p_175763_1_, Entity.class) : Lists.newArrayList(new Entity[]{CommandBase.func_175768_b(p_175763_0_, p_175763_1_)});
    }
    ...
    /**
     * Creates a linguistic series joining the input objects together. Examples:
     * 1) {} --> "", 2) {"Steve"} --> "Steve", 3) {"Steve", "Phil"} -->
     * "Steve and Phil", 4) {"Steve", "Phil", "Mark"} --> "Steve, Phil and Mark"
     */
     ...
     * collection. Examples: 1) {} --> "", 2) {"Steve"} --> "Steve", 3)
     * {"Steve", "Phil"} --> "Steve and Phil", 4) {"Steve", "Phil", "Mark"} -->
     * "Steve, Phil and Mark"
     */
    ...
    public static List func_175762_a(String[] p_175762_0_, Collection p_175762_1_) {
        ...
        if (!p_175762_1_.isEmpty()) {
            ...
            while (var4.hasNext()) {
                ...
                if (CommandBase.doesStringStartWith(var2, var5)) {
                    var3.add(var5);
                }
            }
            ...
            if (var3.isEmpty()) {
                ...
                while (var4.hasNext()) {
                    ...
                    if (var6 instanceof ResourceLocation && CommandBase.doesStringStartWith(var2, ((ResourceLocation) var6).getResourcePath())) {
