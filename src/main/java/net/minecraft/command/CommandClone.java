...
public class CommandClone extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 9) {
            ...
            BlockPos var3 = CommandBase.func_175757_a(sender, args, 0, false);
            BlockPos var4 = CommandBase.func_175757_a(sender, args, 3, false);
            BlockPos var5 = CommandBase.func_175757_a(sender, args, 6, false);
                    ...
                    if (var6.minY >= 0 && var6.maxY < 256 && var7.minY >= 0 && var7.maxY < 256) {
                        ...
                        if (var12.isAreaLoaded(var6) && var12.isAreaLoaded(var7)) {
                            ...
                            if (var8 <= 0) {
                                ...
                                CommandBase.notifyOperators(sender, this, "commands.clone.success", new Object[]{Integer.valueOf(var8)});
                            }
                        } else {
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length > 0 && args.length <= 3 ? CommandBase.func_175771_a(args, 0, pos) : (args.length > 3 && args.length <= 6 ? CommandBase.func_175771_a(args, 3, pos) : (args.length > 6 && args.length <= 9 ? CommandBase.func_175771_a(args, 6, pos) : (args.length == 10 ? CommandBase.getListOfStringsMatchingLastWord(args, new String[]{"replace", "masked", "filtered"}) : (args.length == 11 ? CommandBase.getListOfStringsMatchingLastWord(args, new String[]{"normal", "force", "move"}) : (args.length == 12 && "filtered".equals(args[9]) ? CommandBase.func_175762_a(args, Block.blockRegistry.getKeys()) : null)))));
    }
