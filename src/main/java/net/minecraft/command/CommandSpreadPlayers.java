...
public class CommandSpreadPlayers extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 6) {
            ...
            int var17 = var3 + 1;
            double var5 = CommandBase.func_175761_b(var10000, args[var3], true);
            double var7 = CommandBase.func_175761_b(var4.getZ(), args[var17++], true);
            double var9 = CommandBase.parseDouble(args[var17++], 0.0D);
            double var11 = CommandBase.parseDouble(args[var17++], var9 + 1.0D);
            boolean var13 = CommandBase.parseBoolean(args[var17++]);
            ...
            if (var14.isEmpty()) {
                ...
                func_110669_a(sender, var14, new CommandSpreadPlayers.Position(var5, var7), var9, var11, ((Entity) var14.get(0)).worldObj, var13);
            }
        }
    }
    ...
    private void func_110669_a(ICommandSender p_110669_1_, List p_110669_2_, CommandSpreadPlayers.Position p_110669_3_, double p_110669_4_, double p_110669_6_, World worldIn, boolean p_110669_9_) throws CommandException {
        ...
        CommandSpreadPlayers.Position[] var19 = func_110670_a(var10, p_110669_9_ ? func_110667_a(p_110669_2_) : p_110669_2_.size(), var11, var13, var15, var17);
        int var20 = func_110668_a(p_110669_3_, p_110669_4_, worldIn, var10, var11, var13, var15, var17, var19, p_110669_9_);
        double var21 = func_110671_a(p_110669_2_, worldIn, var19, p_110669_9_);
        CommandBase.notifyOperators(p_110669_1_, this, "commands.spreadplayers.success." + (p_110669_9_ ? "teams" : "players"), new Object[]{Integer.valueOf(var19.length), Double.valueOf(p_110669_3_.field_111101_a), Double.valueOf(p_110669_3_.field_111100_b)});
    ...
    private double func_110671_a(List p_110671_1_, World worldIn, CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_) {
        ...
        for (int var9 = 0; var9 < p_110671_1_.size(); ++var9) {
            ...
            for (Position element : p_110671_3_) {
                if (var11 != element) {
