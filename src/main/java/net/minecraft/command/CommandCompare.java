...
public class CommandCompare extends CommandBase {
        ...
        if (args.length < 9) {
            ...
            if (var8 > 524288) {
                ...
                if (var9.isAreaLoaded(var6) && var9.isAreaLoaded(var7)) {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.compare.success", new Object[]{Integer.valueOf(var8)});
                } else {
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length > 0 && args.length <= 3 ? CommandBase.func_175771_a(args, 0, pos) : (args.length > 3 && args.length <= 6 ? CommandBase.func_175771_a(args, 3, pos) : (args.length > 6 && args.length <= 9 ? CommandBase.func_175771_a(args, 6, pos) : (args.length == 10 ? CommandBase.getListOfStringsMatchingLastWord(args, new String[]{"masked", "all"}) : null)));
    }
}
