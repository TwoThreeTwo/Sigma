    ...
    public static class ArmoredMob implements Predicate {
        ...
        public boolean func_180100_a(Entity p_180100_1_) {
            if (!p_180100_1_.isEntityAlive()) {
                ...
                return var2.getEquipmentInSlot(EntityLiving.getArmorPosition(field_96567_c)) != null ? false : (var2 instanceof EntityLiving ? ((EntityLiving) var2).canPickUpLoot() : (var2 instanceof EntityArmorStand ? true : var2 instanceof EntityPlayer));
            }
        }
