...
public class CommandStats extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 1) {
            ...
            if (var6 == null) {
                ...
                if (var3) {
                    var9 = CommandBase.func_175757_a(sender, args, 1, false);
                    ...
                    Entity var12 = CommandBase.func_175768_b(sender, args[1]);
                ...
                if ("set".equals(var5)) {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.stats.success", new Object[]{var6.func_179637_b(), var14, var13});
                } else if ("clear".equals(var5)) {
                    CommandResultStats.func_179667_a(var8, var6, (String) null, (String) null);
                    CommandBase.notifyOperators(sender, this, "commands.stats.cleared", new Object[]{var6.func_179637_b()});
                }
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length == 1 ? CommandBase.getListOfStringsMatchingLastWord(args, new String[]{"entity", "block"}) : (args.length == 2 && args[0].equals("entity") ? CommandBase.getListOfStringsMatchingLastWord(args, func_175776_d()) : ((args.length != 3 || !args[0].equals("entity")) && (args.length != 5 || !args[0].equals("block")) ? ((args.length != 4 || !args[0].equals("entity")) && (args.length != 6 || !args[0].equals("block")) ? ((args.length != 6 || !args[0].equals("entity")) && (args.length != 8 || !args[0].equals("block")) ? null : CommandBase.func_175762_a(args, func_175777_e())) : CommandBase.getListOfStringsMatchingLastWord(args, CommandResultStats.Type.func_179634_c())) : CommandBase.getListOfStringsMatchingLastWord(args, new String[]{"set", "clear"})));
    }
