            ...
            if (var4 != S45PacketTitle.Type.CLEAR && var4 != S45PacketTitle.Type.RESET) {
                if (var4 == S45PacketTitle.Type.TIMES) {
                    if (args.length != 5) {
                        ...
                        int var11 = CommandBase.parseInt(args[2]);
                        int var12 = CommandBase.parseInt(args[3]);
                        int var13 = CommandBase.parseInt(args[4]);
                    ...
                    String var10 = CommandBase.func_180529_a(args, 2);
                    IChatComponent var6;
