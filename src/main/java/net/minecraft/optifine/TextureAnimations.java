...
public class TextureAnimations {
    ...
    public static void update() {
        ...
        TextureAnimations.textureAnimations = TextureAnimations.getTextureAnimations(rps);
    ...
    public static void updateAnimations() {
        if (TextureAnimations.textureAnimations != null) {
            for (TextureAnimation anim : TextureAnimations.textureAnimations) {
                anim.updateTexture();
            }
        }
    }
    ...
    public static TextureAnimation[] getTextureAnimations(IResourcePack rp) {
        if (!(rp instanceof AbstractResourcePack)) {
            ...
            if (tpFile == null) {
                ...
                if (tpFile.isFile()) {
                    animPropNames = TextureAnimations.getAnimationPropertiesZip(tpFile);
                } else {
                    animPropNames = TextureAnimations.getAnimationPropertiesDir(tpFile);
                }
                ...
                if (animPropNames == null) {
                    ...
                    for (String propName : animPropNames) {
                    ...
                    TextureAnimation[] var14 = ((TextureAnimation[]) list.toArray(new TextureAnimation[list.size()]));
                    return var14;
                }
            }
        }
    ...
    public static String[] getAnimationPropertiesDir(File tpDir) {
        ...
        if (!dirAnim.exists()) {
            ...
            if (propFiles == null) {
                ...
                String[] var7 = ((String[]) list.toArray(new String[list.size()]));
                return var7;
            }
        }
    }
    ...
    public static String[] getAnimationPropertiesZip(File tpFile) {
        try {
            ...
            e.close();
            String[] props1 = ((String[]) list.toArray(new String[list.size()]));
            return props1;
