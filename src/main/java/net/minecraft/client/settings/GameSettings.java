...
public class GameSettings {
    ...
    public KeyBinding keybindSpectateView;
    ...
    public GameSettings(Minecraft mcIn, File p_i46326_2_) {
        ...
        this.keybindSpectateView = new KeyBinding("key.spectatorOutlines", 0, "key.categories.misc");
