...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
     ...
     */
    public static void drawOutlinedBoundingBox(AxisAlignedBB box, int color) {
    ...
    public void func_174966_b() {
        if (OpenGlHelper.shadersSupported) {
            ...
            try {
                this.shaders = new ShaderGroup(this.mc.getTextureManager(), this.mc.getResourceManager(), this.mc.getFramebuffer(), var1);
                this.shaders.createBindFramebuffers(this.mc.displayWidth, this.mc.displayHeight);
    ...
    public void func_180446_a(Entity p_180446_1_, ICamera p_180446_2_, float partialTicks) {
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            for (var18 = 0; var18 < this.theWorld.weatherEffects.size(); ++var18) {
                entity = (Entity) this.theWorld.weatherEffects.get(var18);
            ...
            if (this.func_174985_d()) {
                ...
                for (var18 = 0; var18 < var17.size(); ++var18) {
                    ...
                    boolean var26 = entity.isInRangeToRender3d(var4, var6, var8) && (entity.ignoreFrustumCheck || p_180446_2_.isBoundingBoxInFrustum(entity.getEntityBoundingBox()) || entity.riddenByEntity == this.mc.thePlayer);

                    if ((entity != this.mc.func_175606_aa() || this.mc.gameSettings.thirdPersonView != 0 || var25) && var26) {
                        this.field_175010_j.renderEntitySimple(entity, partialTicks);
                    }
                }
    ...
    public void func_174976_a(float partialTicks, int pass) {
        ...
        if (this.mc.theWorld.provider.getDimensionId() == 1) {
            ...
            if (var261 != null && Config.isSunMoonEnabled()) {
                ...
                var251.setColorRGBA(var10, var11, var12, var261[3]);
                var251.addVertex(0.0D, 100.0D, 0.0D);
                boolean var26 = true;
                var251.setColorRGBA(var261[0], var261[1], var261[2], 0.0F);
            ...
            if (this.mc.theWorld.provider.isSurfaceWorld()) {
                if (Config.isCloudsFancy()) {
                    ...
                    if (this.isFancyGlListClouds || this.cloudTickCounter >= this.cloudTickCounterGlList + 20) {
                        ...
                        var7.setColorRGBA(exactPlayerX, var10, exactPlayerY, 0.8F);
            ...
            if (!this.isFancyGlListClouds || this.cloudTickCounter >= this.cloudTickCounterGlList + 20) {
                ...
                for (int entityliving = -3; entityliving <= 4; ++entityliving) {
                    for (int exactPlayerX = -3; exactPlayerX <= 4; ++exactPlayerX) {
                        ...
                        if (var14 > -5.0F) {
                            var5.setColorRGBA(var18 * 0.7F, var19 * 0.7F, var20 * 0.7F, 0.8F);
                        ...
                        if (var14 <= 5.0F) {
                            var5.setColorRGBA(var18, var19, var20, 0.8F);
                            var5.func_178980_d(0.0F, 1.0F, 0.0F);
                        ...
                        var5.setColorRGBA(var18 * 0.9F, var19 * 0.9F, var20 * 0.9F, 0.8F);
                        int var36;
                        ...
                        var5.setColorRGBA(var18 * 0.8F, var19 * 0.8F, var20 * 0.8F, 0.8F);
     ...
     */
    public void drawSelectionBox(EntityPlayer player, MovingObjectPosition mouseOver, int i, float partialTick) {
        if (i == 0 && mouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            GlStateManager.depthMask(false);
            float var5 = 0.002F;
            BlockPos var6 = mouseOver.getBlockPos();
            ...
            if (var7.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(var6)) {
                ...
                double var8 = player.lastTickPosX + (player.posX - player.lastTickPosX) * (double) partialTick;
                double var10 = player.lastTickPosY + (player.posY - player.lastTickPosY) * (double) partialTick;
                double var12 = player.lastTickPosZ + (player.posZ - player.lastTickPosZ) * (double) partialTick;
