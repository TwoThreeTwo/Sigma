...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float p_78440_1_) {
        ...
        boolean var420 = var3.getCurrentEquippedItem() != null && !(var3.getCurrentEquippedItem().getItem() instanceof ItemBlock) && Client.getModuleManager().get(Scaffold.class).isEnabled();
        float var4 = var420 ? 0 : var3.getSwingProgress(p_78440_1_);
