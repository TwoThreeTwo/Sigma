...
public class GlStateManager {
    ...
    private static GlStateManager.TextureState[] textureStates = new GlStateManager.TextureState[8];
    ...
    static {
        ...
        for (var0 = 0; var0 < 8; ++var0) {
            textureStates[var0] = new GlStateManager.TextureState((GlStateManager.SwitchTexGen) null);
        }
    }
    ...
    public static void setActiveTexture(int p_179138_0_) {
        if (textureIndex != p_179138_0_ - OpenGlHelper.defaultTexUnit) {
            textureIndex = p_179138_0_ - OpenGlHelper.defaultTexUnit;
            OpenGlHelper.setActiveTexture(p_179138_0_);
        }
    }

    public static void enableTextures() {
        textureStates[textureIndex].status.setEnabled();
    }

    public static void disableTextures() {
        textureStates[textureIndex].status.setDisabled();
    }
    ...
    public static void func_179150_h(int p_179150_0_) {
        ...
        GlStateManager.TextureState[] var1 = textureStates;
    ...
    public static void bindTexture(int p_179144_0_) {
        if (p_179144_0_ != textureStates[textureIndex].field_179059_b) {
            textureStates[textureIndex].field_179059_b = p_179144_0_;
    ...
    static class TextureState {
        ...
        public GlStateManager.BooleanState status;
        public int field_179059_b;

        private TextureState() {
            this.status = new GlStateManager.BooleanState(3553);
