...
import net.minecraft.optifine.IntegerCache;
...
public class VisGraph {
    ...
    public void func_178606_a(BlockPos p_178606_1_) {
        if (Client.getModuleManager().isEnabled(Xray.class) || Client.getModuleManager().isEnabled(Phase.class) || Client.getModuleManager().get(Freecam.class).isEnabled()) {
            return;
        }
