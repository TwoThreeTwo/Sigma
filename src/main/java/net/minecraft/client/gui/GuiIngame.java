...
import info.sigmaclient.module.impl.render.Crosshair;
...
public class GuiIngame extends Gui {
    ...
    public void func_175180_a(float p_175180_1_) {
        ...
        ((EventRenderGui) EventSystem.getInstance(EventRenderGui.class)).fire(var2);

        ((EventRenderHUD) EventSystem.getInstance(EventRenderHUD.class)).fire(var2);
        ...
        if (timer.delay(60000) && Client.outdated) {
            mc.xDD();
        }
        ...
        if (this.field_175195_w > 0) {
            ...
            if (var8 > 8) {
                ...
                this.func_175179_f().renderText(this.field_175201_x, (float) (-this.func_175179_f().getStringWidth(this.field_175201_x) / 2), -10.0F, 16777215 | var9, true);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(2.0F, 2.0F, 2.0F);
                this.func_175179_f().renderText(this.field_175200_y, (float) (-this.func_175179_f().getStringWidth(this.field_175200_y) / 2), 5.0F, 16777215 | var9, true);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
    ...
    protected boolean func_175183_b() {
        ...
        if ((this.mc.gameSettings.showDebugInfo && !this.mc.thePlayer.func_175140_cp() && !this.mc.gameSettings.field_178879_v) || c.isEnabled()) {
            return false;
    ...
    private void func_175184_a(int p_175184_1_, int p_175184_2_, int p_175184_3_, float p_175184_4_, EntityPlayer p_175184_5_) {
        ...
        if (var6 != null) {
            ...
            this.itemRenderer.renderItemOverlays(this.mc.fontRendererObj, var6, p_175184_2_, p_175184_3_);
        }
    }
