...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    protected String customizeWorldSettings = "Customize World Settings";
    protected String pageXofY = "Page 1 of 3";
    protected String basicSettings = "Basic Settings";
    protected String[] strArray = new String[4];
    ...
    public GuiCustomizeWorldScreen(GuiScreen p_i45521_1_, String p_i45521_2_) {
        this.guiCreateWorld = (GuiCreateWorld) p_i45521_1_;
     ...
     */
    public void initGui() {
        this.customizeWorldSettings = I18n.format("options.customizeTitle", new Object[0]);
        this.buttonList.clear();
        this.buttonList.add(this.btnPrevious = new GuiButton(302, 20, 5, 80, 20, I18n.format("createWorld.customize.custom.prev", new Object[0])));
        this.buttonList.add(this.btnNext = new GuiButton(303, this.width - 100, 5, 80, 20, I18n.format("createWorld.customize.custom.next", new Object[0])));
        this.buttonList.add(this.btnDefaults = new GuiButton(304, this.width / 2 - 187, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults", new Object[0])));
        this.buttonList.add(this.btnRandom = new GuiButton(301, this.width / 2 - 92, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize", new Object[0])));
        this.buttonList.add(this.btnPresets = new GuiButton(305, this.width / 2 + 3, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.presets", new Object[0])));
        this.buttonList.add(this.btnDone = new GuiButton(300, this.width / 2 + 98, this.height - 27, 90, 20, I18n.format("gui.done", new Object[0])));
        this.btnYes = new GuiButton(306, this.width / 2 - 55, 160, 50, 20, I18n.format("gui.yes", new Object[0]));
        this.btnYes.visible = false;
        this.buttonList.add(this.btnYes);
        this.btnNo = new GuiButton(307, this.width / 2 + 5, 160, 50, 20, I18n.format("gui.no", new Object[0]));
        this.btnNo.visible = false;
        this.buttonList.add(this.btnNo);
        this.func_175325_f();
    }
    ...
    public void handleMouseInput() throws IOException {
        ...
        this.guiPageButtonList.handleMouseScrolling();
    }
    ...
    private void func_175325_f() {
        ...
        this.guiPageButtonList = new GuiPageButtonList(this.mc, this.width, this.height, 32, this.height - 32, 25, this, new GuiPageButtonList.GuiListEntry[][]{var1, var2, var3, var4});

        for (int var5 = 0; var5 < 4; ++var5) {
            this.strArray[var5] = I18n.format("createWorld.customize.custom.page" + var5, new Object[0]);
        }
    ...
    public void func_175324_a(String p_175324_1_) {
        if (p_175324_1_ != null && p_175324_1_.length() != 0) {
            this.field_175336_F = ChunkProviderSettings.Factory.createFactory(p_175324_1_);
        } else {
    ...
    public void func_175319_a(int p_175319_1_, String p_175319_2_) {
        ...
        if (var4 != var3 && var3 != 0.0F) {
            ((GuiTextField) this.guiPageButtonList.func_178061_c(p_175319_1_)).setText(this.func_175330_b(p_175319_1_, var4));
        }

        ((GuiSlider) this.guiPageButtonList.func_178061_c(p_175319_1_ - 132 + 100)).func_175218_a(var4, false);
    ...
    public void func_175320_a(int p_175320_1_, float p_175320_2_) {
        ...
        if (p_175320_1_ >= 100 && p_175320_1_ < 116) {
            Gui var3 = this.guiPageButtonList.func_178061_c(p_175320_1_ - 100 + 132);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            switch (button.id) {
                case 300:
                    this.guiCreateWorld.field_146334_a = this.field_175336_F.toString();
                    this.mc.displayGuiScreen(this.guiCreateWorld);
                    break;

                case 301:
                    for (int var2 = 0; var2 < this.guiPageButtonList.getSize(); ++var2) {
                        GuiPageButtonList.GuiEntry var3 = this.guiPageButtonList.func_178070_d(var2);
                ...
                case 302:
                    this.guiPageButtonList.func_178071_h();
                    this.func_175328_i();
                    break;

                case 303:
                    this.guiPageButtonList.func_178064_i();
                    this.func_175328_i();
                    break;
    ...
    private void func_175331_h() throws IOException {
        switch (this.field_175339_B) {
            case 300:
                this.actionPerformed((GuiListButton) this.guiPageButtonList.func_178061_c(300));
                break;
    ...
    private void func_175329_a(boolean p_175329_1_) {
        this.btnYes.visible = p_175329_1_;
        this.btnNo.visible = p_175329_1_;
        this.btnRandom.enabled = !p_175329_1_;
        this.btnDone.enabled = !p_175329_1_;
        this.btnPrevious.enabled = !p_175329_1_;
        this.btnNext.enabled = !p_175329_1_;
        this.btnDefaults.enabled = !p_175329_1_;
        this.btnPresets.enabled = !p_175329_1_;
    }

    private void func_175328_i() {
        this.btnPrevious.enabled = this.guiPageButtonList.func_178059_e() != 0;
        this.btnNext.enabled = this.guiPageButtonList.func_178059_e() != this.guiPageButtonList.func_178057_f() - 1;
        this.pageXofY = I18n.format("book.pageIndicator", new Object[]{Integer.valueOf(this.guiPageButtonList.func_178059_e() + 1), Integer.valueOf(this.guiPageButtonList.func_178057_f())});
        this.basicSettings = this.strArray[this.guiPageButtonList.func_178059_e()];
        this.btnRandom.enabled = this.guiPageButtonList.func_178059_e() != this.guiPageButtonList.func_178057_f() - 1;
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (this.field_175339_B == 0) {
            switch (keyCode) {
                ...
                default:
                    this.guiPageButtonList.func_178062_a(typedChar, keyCode);
            }
        }
    }

    private void func_175327_a(float p_175327_1_) {
        Gui var2 = this.guiPageButtonList.func_178056_g();
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (this.field_175339_B == 0 && !this.field_175340_C) {
            this.guiPageButtonList.func_148179_a(mouseX, mouseY, mouseButton);
        }
    }
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        ...
        if (this.field_175340_C) {
            ...
            this.guiPageButtonList.func_148181_b(mouseX, mouseY, state);
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.guiPageButtonList.drawScreen(mouseX, mouseY, partialTicks);
        this.drawCenteredString(this.fontRendererObj, this.customizeWorldSettings, this.width / 2, 2, 16777215);
        this.drawCenteredString(this.fontRendererObj, this.pageXofY, this.width / 2, 12, 16777215);
        this.drawCenteredString(this.fontRendererObj, this.basicSettings, this.width / 2, 22, 16777215);
        ...
        if (this.field_175339_B != 0) {
            ...
            this.btnYes.drawButton(this.mc, mouseX, mouseY);
            this.btnNo.drawButton(this.mc, mouseX, mouseY);
        }
    }
}
