...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(6969, res.getScaledWidth() / 2, 3, 70, 20, "Disable Aura"));
        this.buttonList.add(new GuiButton(42069, res.getScaledWidth() / 2 - 80, 3, 80, 20, "Disable Cleaner"));
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (Object aButtonList : this.buttonList) {
            ...
            if (var52.mousePressed(this.mc, mouseX, mouseY) && Client.getModuleManager().isEnabled(Killaura.class) && var52.id == 6969) {
                Client.getModuleManager().get(Killaura.class).toggle();
            }
            if (var52.mousePressed(this.mc, mouseX, mouseY) && Client.getModuleManager().isEnabled(InventoryCleaner.class) && var52.id == 42069) {
                Client.getModuleManager().get(InventoryCleaner.class).toggle();
            }
        }
