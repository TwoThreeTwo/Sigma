...
public class GuiPlayerTabOverlay extends Gui {
    public static final Ordering field_175252_a = Ordering.from(new GuiPlayerTabOverlay.PlayerComparator(null));
    ...
    public void func_175249_a(int p_175249_1_, Scoreboard p_175249_2_, ScoreObjective p_175249_3_) {
        if (Client.getModuleManager().isEnabled(StreamerMode.class) && StreamerMode.hideTab)
            return;
        ...
        for (int var30 = 0; var30 < var28; ++var30) {
            ...
            if (var30 < var5.size()) {
                ...
                if (var11) {
                    this.field_175250_f.getTextureManager().bindTexture(var24.getLocationSkin());
        ...
        if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            if (this.field_175253_j == p_175247_6_.getRenderVisibilityId()) {
                if (var7 < p_175247_6_.getLastHealth()) {
                    ...
                    p_175247_6_.setHealthBlinkTime((long) (this.field_175251_g.getUpdateCounter() + 20));
                } else if (var7 > p_175247_6_.getLastHealth()) {
                    p_175247_6_.getLastHealthTime(Minecraft.getSystemTime());
                    p_175247_6_.setHealthBlinkTime((long) (this.field_175251_g.getUpdateCounter() + 10));
                }
            }
            ...
            p_175247_6_.setLastHealth(var7);
            int var8 = MathHelper.ceiling_float_int((float) Math.max(var7, p_175247_6_.getDisplayHealth()) / 2.0F);
            int var9 = Math.max(MathHelper.ceiling_float_int((float) (var7 / 2)), Math.max(MathHelper.ceiling_float_int((float) (p_175247_6_.getDisplayHealth() / 2)), 10));
            boolean var10 = p_175247_6_.getHealthBlinkTime() > (long) this.field_175251_g.getUpdateCounter() && (p_175247_6_.getHealthBlinkTime() - (long) this.field_175251_g.getUpdateCounter()) / 3L % 2L == 1L;
