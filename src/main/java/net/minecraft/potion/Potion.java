...
public class Potion {
    ...
    public static Potion func_180142_b(String p_180142_0_) {
        return (Potion) Potion.field_180150_I.get(new ResourceLocation(p_180142_0_));
    }

    public static String[] func_180141_c() {
        String[] var0 = new String[Potion.field_180150_I.size()];
        int var1 = 0;
        ResourceLocation var3;

        for (Iterator var2 = Potion.field_180150_I.keySet().iterator(); var2.hasNext(); var0[var1++] = var3.toString()) {
    ...
    public void performEffect(EntityLivingBase p_76394_1_, int p_76394_2_) {
        ...
        } else if (id == Potion.hunger.id && p_76394_1_ instanceof EntityPlayer) {
            ((EntityPlayer) p_76394_1_).addExhaustion(0.025F * (p_76394_2_ + 1));
        } else if (id == Potion.saturation.id && p_76394_1_ instanceof EntityPlayer) {
            if (!p_76394_1_.worldObj.isRemote) {
                ((EntityPlayer) p_76394_1_).getFoodStats().addStats(p_76394_2_ + 1, 1.0F);
            }
        } else if ((id != Potion.heal.id || p_76394_1_.isEntityUndead()) && (id != Potion.harm.id || !p_76394_1_.isEntityUndead())) {
            if (id == Potion.harm.id && !p_76394_1_.isEntityUndead() || id == Potion.heal.id && p_76394_1_.isEntityUndead()) {
    ...
    public void func_180793_a(Entity p_180793_1_, Entity p_180793_2_, EntityLivingBase p_180793_3_, int p_180793_4_, double p_180793_5_) {
        ...
        if ((id != Potion.heal.id || p_180793_3_.isEntityUndead()) && (id != Potion.harm.id || !p_180793_3_.isEntityUndead())) {
            if (id == Potion.harm.id && !p_180793_3_.isEntityUndead() || id == Potion.heal.id && p_180793_3_.isEntityUndead()) {
                var7 = (int) (p_180793_5_ * (6 << p_180793_4_) + 0.5D);
            ...
            var7 = (int) (p_180793_5_ * (4 << p_180793_4_) + 0.5D);
