...
public class EntityTracker {
    ...
    public void addEntityToTracker(Entity p_72785_1_, int p_72785_2_, final int p_72785_3_, boolean p_72785_4_) {
        ...
        try {
            ...
            ((EntityTrackerEntry) trackedEntityHashTable.lookup(p_72785_1_.getEntityId())).trackedEntity.addEntityCrashInfo(var8);

            try {
                throw new ReportedException(var6);
            } catch (ReportedException var10) {
                EntityTracker.logger.error("\"Silently\" catching entity tracking error.", var10);
            }
        }
    }
    ...
    public void untrackEntity(Entity p_72790_1_) {
        ...
        EntityTrackerEntry var5 = (EntityTrackerEntry) trackedEntityHashTable.removeObject(p_72790_1_.getEntityId());
