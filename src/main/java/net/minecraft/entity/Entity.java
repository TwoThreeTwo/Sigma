...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (noClip) {
            ...
            double var15 = y;
            double var17 = z;
            boolean var19 = onGround && (isSneaking() || Client.getModuleManager().get(Scaffold.class).isEnabled()) && this instanceof EntityPlayer;
            ...
            for (Iterator var22 = var53.iterator(); var22
            ...
            if (var56 * var56 + var27 * var27 >= x * x + z * z) {
                if (!em.isCancelled()) {
                    if ((em.getStepHeight() > 0.0D) && (var54) && ((var13 != x) || (var17 != z))) {
