...
public class ClassInheratanceMultiMap extends AbstractSet {
    ...
    public void func_180213_a(Class p_180213_1_) {
        Iterator var2 = field_180218_a.get(func_180212_a(p_180213_1_, false)).iterator();
    ...
    public boolean add(Object p_add_1_) {
        Iterator var2 = field_180216_b.iterator();
    ...
    public boolean remove(Object p_remove_1_) {
        ...
        boolean var3 = false;
        Iterator var4 = field_180216_b.iterator();
    ...
    public Iterable func_180215_b(final Class p_180215_1_) {
        return new Iterable() {
            ...
            public Iterator iterator() {
                Iterator var1 = field_180218_a.get(ClassInheratanceMultiMap.this.func_180212_a(p_180215_1_, true)).iterator();
