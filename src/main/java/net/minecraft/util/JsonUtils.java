...
public class JsonUtils {
    ...
    public static boolean func_180199_c(JsonObject p_180199_0_, String p_180199_1_) {
        return !JsonUtils.jsonObjectFieldTypeIsPrimitive(p_180199_0_, p_180199_1_) ? false : p_180199_0_.getAsJsonPrimitive(p_180199_1_).isBoolean();
    }
    ...
    public static JsonObject getJsonObject(JsonObject base, String key) {
        if (base.has(key)) {
            return JsonUtils.getElementAsJsonObject(base.get(key), key);
        } else {
    ...
    public static JsonObject getJsonObjectFieldOrDefault(JsonObject p_151218_0_, String p_151218_1_, JsonObject p_151218_2_) {
        return p_151218_0_.has(p_151218_1_) ? JsonUtils.getElementAsJsonObject(p_151218_0_.get(p_151218_1_), p_151218_1_) : p_151218_2_;
    }
