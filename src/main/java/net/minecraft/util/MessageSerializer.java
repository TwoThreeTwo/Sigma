...
public class MessageSerializer extends MessageToByteEncoder {
    ...
    protected void encode(ChannelHandlerContext p_encode_1_, Packet p_encode_2_, ByteBuf p_encode_3_) throws IOException {
        Integer var4 = ((EnumConnectionState) p_encode_1_.channel().attr(NetworkManager.attrKeyConnectionState).get()).getPacketId(direction, p_encode_2_);
        ...
        if (var4 == null) {
            ...
            try {
                ...
                MessageSerializer.logger.error(var7);
            }
        }
    }
