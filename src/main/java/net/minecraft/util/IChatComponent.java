            ...
            if (p_deserialize_1_.isJsonPrimitive()) {
                ...
                if (p_deserialize_1_.isJsonArray()) {
                    ...
                    while (var15.hasNext()) {
                        ...
                        IChatComponent var18 = deserialize(var17, var17.getClass(), p_deserialize_3_);
                ...
                if (var4.has("text")) {
                    ...
                    if (var4.has("with")) {
                        ...
                        for (int var9 = 0; var9 < var8.length; ++var9) {
                            var8[var9] = deserialize(var7.get(var9), p_deserialize_2_, p_deserialize_3_);
                ...
                if (var4.has("extra")) {
                    ...
                    for (int var16 = 0; var16 < var14.size(); ++var16) {
                        ((IChatComponent) var5).appendSibling(deserialize(var14.get(var16), p_deserialize_2_, p_deserialize_3_));
                    }
                }
