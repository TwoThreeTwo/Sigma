...
public class StringTranslate {
        ...
        try {
            ...
            while (var2.hasNext()) {
                ...
                if (!var3.isEmpty() && var3.charAt(0) != 35) {
                    String[] var4 = Iterables.toArray(StringTranslate.equalSignSplitter.split(var3), String.class);

                    if (var4 != null && var4.length == 2) {
                        String var5 = var4[0];
                        String var6 = StringTranslate.numericVariablePattern.matcher(var4[1]).replaceAll("%$1s");
    ...
    public synchronized String translateKeyFormat(String p_74803_1_, Object... p_74803_2_) {
        String var3 = tryTranslateKey(p_74803_1_);
