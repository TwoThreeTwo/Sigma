...
public class ItemMonsterPlacer extends Item {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (worldIn.isRemote) {
            ...
            Entity var12 = ItemMonsterPlacer.spawnCreature(worldIn, stack.getMetadata(), pos.getX() + 0.5D, pos.getY() + var13, pos.getZ() + 0.5D);
            ...
            if (var4 == null) {
                ...
                if (var4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                    ...
                    if (worldIn.getBlockState(var5).getBlock() instanceof BlockLiquid) {
                        Entity var6 = ItemMonsterPlacer.spawnCreature(worldIn, itemStackIn.getMetadata(), var5.getX() + 0.5D, var5.getY() + 0.5D, var5.getZ() + 0.5D);
