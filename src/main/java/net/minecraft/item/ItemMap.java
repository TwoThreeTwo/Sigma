...
public class ItemMap extends ItemMapBase {
    ...
    public void updateMapData(World worldIn, Entity p_77872_2_, MapData p_77872_3_) {
        if (worldIn.provider.getDimensionId() == p_77872_3_.dimension && p_77872_2_ instanceof EntityPlayer) {
            ...
            int var7 = MathHelper.floor_double(p_77872_2_.posX - var5) / var4 + 64;
            int var8 = MathHelper.floor_double(p_77872_2_.posZ - var6) / var4 + 64;
            int var9 = 128 / var4;
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List tooltip, boolean advanced) {
        MapData var5 = getMapData(stack, playerIn.worldObj);
