...
public class ItemDye extends Item {
    ...
    public static boolean func_179234_a(ItemStack p_179234_0_, World worldIn, BlockPos pos) {
    ...
    public static void func_180617_a(World worldIn, BlockPos p_180617_1_, int p_180617_2_) {
        ...
        if (var3.getMaterial() != Material.air) {
            ...
            for (int var4 = 0; var4 < p_180617_2_; ++var4) {
                double var5 = Item.itemRand.nextGaussian() * 0.02D;
                double var7 = Item.itemRand.nextGaussian() * 0.02D;
                double var9 = Item.itemRand.nextGaussian() * 0.02D;
                worldIn.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY, p_180617_1_.getX() + Item.itemRand.nextFloat(), p_180617_1_.getY() + Item.itemRand.nextFloat() * var3.getBlockBoundsMaxY(), p_180617_1_.getZ() + Item.itemRand.nextFloat(), var5, var7, var9, new int[0]);
            }
        }
    }
