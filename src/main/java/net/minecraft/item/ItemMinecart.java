...
public class ItemMinecart extends Item {
    private static final IBehaviorDispenseItem dispenserMinecartBehavior = new BehaviorDefaultDispenseItem() {
        ...
        public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            ...
            double var5 = source.getX() + var3.getFrontOffsetX() * 1.125D;
            double var7 = Math.floor(source.getY()) + var3.getFrontOffsetY();
            double var9 = source.getZ() + var3.getFrontOffsetZ() * 1.125D;
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (BlockRailBase.func_176563_d(var9)) {
            if (!worldIn.isRemote) {
                ...
                EntityMinecart var13 = EntityMinecart.func_180458_a(worldIn, pos.getX() + 0.5D, pos.getY() + 0.0625D + var11, pos.getZ() + 0.5D, minecartType);
