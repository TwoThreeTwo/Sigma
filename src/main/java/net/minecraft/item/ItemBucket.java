        ...
        if (var5 == null) {
            ...
            if (var5.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (var4) {
                    ...
                    BlockPos var9 = var6.offset(var5.facing);

                    if (!playerIn.func_175151_a(var9, var5.facing, itemStackIn)) {
                        return itemStackIn;
                    }

                    if (func_180616_a(worldIn, var9) && !playerIn.capabilities.isCreativeMode) {
                        playerIn.triggerAchievement(StatList.objectUseStats[Item.getIdFromItem(this)]);
                        return new ItemStack(Items.bucket);
                    }
                }
    ...
    public boolean func_180616_a(World worldIn, BlockPos p_180616_2_) {
        if (isFull == Blocks.air) {
            ...
            if (!worldIn.isAirBlock(p_180616_2_) && !var4) {
                ...
                if (worldIn.provider.func_177500_n() && isFull == Blocks.flowing_water) {
