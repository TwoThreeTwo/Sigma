...
public class ItemPotion extends Item {
    ...
    public List getEffects(ItemStack p_77832_1_) {
        if (p_77832_1_.hasTagCompound() && p_77832_1_.getTagCompound().hasKey("CustomPotionEffects", 9)) {
            ...
            List var2 = (List) effectCache.get(Integer.valueOf(p_77832_1_.getMetadata()));

            if (var2 == null) {
                var2 = PotionHelper.getPotionEffects(p_77832_1_.getMetadata(), false);
                effectCache.put(Integer.valueOf(p_77832_1_.getMetadata()), var2);
            }
    ...
    public void getSubItems(Item itemIn, CreativeTabs tab, List subItems) {
                ...
                for (var5 = 0; var5 <= 1; ++var5) {
                    ...
                    for (int var7 = 0; var7 <= 2; ++var7) {
                        ...
                        if (var9 != null && !var9.isEmpty()) {
                            ItemPotion.field_77835_b.put(var9, Integer.valueOf(var8));
                        }
                    }
                }
            }
        ...
        Iterator var10 = ItemPotion.field_77835_b.values().iterator();
