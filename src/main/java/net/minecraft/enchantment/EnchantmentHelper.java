...
public class EnchantmentHelper {
    ...
    public static int getEnchantmentModifierDamage(ItemStack[] p_77508_0_, DamageSource p_77508_1_) {
        ...
        EnchantmentHelper.applyEnchantmentModifierArray(EnchantmentHelper.enchantmentModifierDamage, p_77508_0_);
    ...
    public static float func_152377_a(ItemStack p_152377_0_, EnumCreatureAttribute p_152377_1_) {
        ...
        EnchantmentHelper.applyEnchantmentModifier(EnchantmentHelper.enchantmentModifierLiving, p_152377_0_);
    ...
    public static void func_151384_a(EntityLivingBase p_151384_0_, Entity p_151384_1_) {
        ...
        if (p_151384_0_ != null) {
            EnchantmentHelper.applyEnchantmentModifierArray(EnchantmentHelper.field_151388_d, p_151384_0_.getInventory());
        }

        if (p_151384_1_ instanceof EntityPlayer) {
            EnchantmentHelper.applyEnchantmentModifier(EnchantmentHelper.field_151388_d, p_151384_0_.getHeldItem());
        }
    }
    ...
    public static void func_151385_b(EntityLivingBase p_151385_0_, Entity p_151385_1_) {
        ...
        if (p_151385_0_ != null) {
            EnchantmentHelper.applyEnchantmentModifierArray(EnchantmentHelper.field_151389_e, p_151385_0_.getInventory());
        }

        if (p_151385_0_ instanceof EntityPlayer) {
            EnchantmentHelper.applyEnchantmentModifier(EnchantmentHelper.field_151389_e, p_151385_0_.getHeldItem());
        }
    }
    ...
    public static int getRespiration(EntityLivingBase p_77501_0_) {
        return EnchantmentHelper.getEnchantmentLevel(Enchantment.knockback.effectId, p_77501_0_.getHeldItem());
    }
    ...
    public static ItemStack func_92099_a(Enchantment p_92099_0_, EntityLivingBase p_92099_1_) {
        ...
        for (int var4 = 0; var4 < var3; ++var4) {
            ...
            if (var5 != null && EnchantmentHelper.getEnchantmentLevel(p_92099_0_.effectId, var5) > 0) {
                return var5;
            }
        }
