...
public abstract class Enchantment {
    ...
    static {
        ...
        Enchantment[] var1 = Enchantment.field_180311_a;
    ...
    public static Enchantment func_180305_b(String p_180305_0_) {
        return (Enchantment) Enchantment.field_180307_E.get(new ResourceLocation(p_180305_0_));
    }

    public static String[] func_180304_c() {
        String[] var0 = new String[Enchantment.field_180307_E.size()];
        int var1 = 0;
        ResourceLocation var3;

        for (Iterator var2 = Enchantment.field_180307_E.keySet().iterator(); var2.hasNext(); var0[var1++] = var3.toString()) {
