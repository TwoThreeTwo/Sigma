...
public class BlockMycelium extends Block {
    ...
    protected BlockMycelium() {
        ...
        setDefaultState(blockState.getBaseState().withProperty(BlockMycelium.SNOWY_PROP, Boolean.valueOf(false)));
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        return state.withProperty(BlockMycelium.SNOWY_PROP, Boolean.valueOf(var4 == Blocks.snow || var4 == Blocks.snow_layer));
    }
