...
public class BlockSapling extends BlockBush implements IGrowable {
    ...
    protected BlockSapling() {
        setDefaultState(blockState.getBaseState().withProperty(BlockSapling.TYPE_PROP, BlockPlanks.EnumType.OAK).withProperty(BlockSapling.STAGE_PROP, Integer.valueOf(0)));
        float var1 = 0.4F;
    ...
    public void func_176478_d(World worldIn, BlockPos p_176478_2_, IBlockState p_176478_3_, Random p_176478_4_) {
        if (((Integer) p_176478_3_.getValue(BlockSapling.STAGE_PROP)).intValue() == 0) {
    ...
    public void func_176476_e(World worldIn, BlockPos p_176476_2_, IBlockState p_176476_3_, Random p_176476_4_) {
        ...
        switch (BlockSapling.SwitchEnumType.field_177065_a[((BlockPlanks.EnumType) p_176476_3_.getValue(BlockSapling.TYPE_PROP)).ordinal()]) {
            case 1:
                label78:
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(BlockSapling.TYPE_PROP, BlockPlanks.EnumType.func_176837_a(meta & 7)).withProperty(BlockSapling.STAGE_PROP, Integer.valueOf((meta & 8) >> 3));
    }
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        var3 |= ((Integer) state.getValue(BlockSapling.STAGE_PROP)).intValue() << 3;
        return var3;
    }
