...
public class BlockFurnace extends BlockContainer {
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (isBurning) {
            EnumFacing var5 = (EnumFacing) state.getValue(BlockFurnace.FACING);
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        return getDefaultState().withProperty(BlockFurnace.FACING, placer.func_174811_aO().getOpposite());
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        ...
        return getDefaultState().withProperty(BlockFurnace.FACING, var2);
    }
