...
public class BlockFlowerPot extends BlockContainer {
    ...
    public BlockFlowerPot() {
        ...
        setDefaultState(blockState.getBaseState().withProperty(BlockFlowerPot.field_176443_b, BlockFlowerPot.EnumFlowerType.EMPTY).withProperty(BlockFlowerPot.field_176444_a, Integer.valueOf(0)));
    ...
    public int getMetaFromState(IBlockState state) {
        return ((Integer) state.getValue(BlockFlowerPot.field_176444_a)).intValue();
    }
