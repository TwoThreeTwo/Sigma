...
public class BlockHugeMushroom extends Block {
    ...
    public BlockHugeMushroom(Material p_i45711_1_, Block p_i45711_2_) {
        super(p_i45711_1_);
        setDefaultState(blockState.getBaseState().withProperty(BlockHugeMushroom.field_176380_a, BlockHugeMushroom.EnumType.ALL_OUTSIDE));
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(BlockHugeMushroom.field_176380_a, BlockHugeMushroom.EnumType.func_176895_a(meta));
    }
    ...
    public int getMetaFromState(IBlockState state) {
        return ((BlockHugeMushroom.EnumType) state.getValue(BlockHugeMushroom.field_176380_a)).func_176896_a();
    }
    ...
    public static enum EnumType implements IStringSerializable {
        ...
        static {
            BlockHugeMushroom.EnumType[] var0 = EnumType.values();
            int var1 = var0.length;

            for (int var2 = 0; var2 < var1; ++var2) {
                BlockHugeMushroom.EnumType var3 = var0[var2];
                EnumType.field_176905_n[var3.func_176896_a()] = var3;
            }
        }
        ...
        public static BlockHugeMushroom.EnumType func_176895_a(int p_176895_0_) {
            ...
            BlockHugeMushroom.EnumType var1 = EnumType.field_176905_n[p_176895_0_];
