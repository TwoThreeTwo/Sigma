...
public class BlockPistonBase extends Block {
    ...
    public BlockPistonBase(boolean p_i45443_1_) {
        ...
        setDefaultState(blockState.getBaseState().withProperty(BlockPistonBase.FACING, EnumFacing.NORTH).withProperty(BlockPistonBase.EXTENDED, Boolean.valueOf(false)));
    ...
    public static EnumFacing func_180695_a(World worldIn, BlockPos p_180695_1_, EntityLivingBase p_180695_2_) {
        if (MathHelper.abs((float) p_180695_2_.posX - p_180695_1_.getX()) < 2.0F && MathHelper.abs((float) p_180695_2_.posZ - p_180695_1_.getZ()) < 2.0F) {
            double var3 = p_180695_2_.posY + p_180695_2_.getEyeHeight();
    ...
    public static boolean func_180696_a(Block p_180696_0_, World worldIn, BlockPos p_180696_2_, EnumFacing p_180696_3_, boolean p_180696_4_) {
        if (p_180696_0_ == Blocks.obsidian) {
            ...
            if (p_180696_2_.getY() <= worldIn.getHeight() - 1 && (p_180696_3_ != EnumFacing.UP || p_180696_2_.getY() != worldIn.getHeight() - 1)) {
                ...
                } else if (((Boolean) worldIn.getBlockState(p_180696_2_).getValue(BlockPistonBase.EXTENDED)).booleanValue()) {
                    return false;
                }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        worldIn.setBlockState(pos, state.withProperty(BlockPistonBase.FACING, BlockPistonBase.func_180695_a(worldIn, pos, placer)), 2);
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        return getDefaultState().withProperty(BlockPistonBase.FACING, BlockPistonBase.func_180695_a(worldIn, pos, placer)).withProperty(BlockPistonBase.EXTENDED, Boolean.valueOf(false));
    }

    private void func_176316_e(World worldIn, BlockPos p_176316_2_, IBlockState p_176316_3_) {
        EnumFacing var4 = (EnumFacing) p_176316_3_.getValue(BlockPistonBase.FACING);
        boolean var5 = func_176318_b(worldIn, p_176316_2_, var4);

        if (var5 && !((Boolean) p_176316_3_.getValue(BlockPistonBase.EXTENDED)).booleanValue()) {
        ...
        } else if (!var5 && ((Boolean) p_176316_3_.getValue(BlockPistonBase.EXTENDED)).booleanValue()) {
            worldIn.setBlockState(p_176316_2_, p_176316_3_.withProperty(BlockPistonBase.EXTENDED, Boolean.valueOf(false)), 2);
    ...
    public boolean onBlockEventReceived(World worldIn, BlockPos pos, IBlockState state, int eventID, int eventParam) {
        EnumFacing var6 = (EnumFacing) state.getValue(BlockPistonBase.FACING);

        if (!worldIn.isRemote) {
            boolean var7 = func_176318_b(worldIn, pos, var6);

            if (var7 && eventID == 1) {
                worldIn.setBlockState(pos, state.withProperty(BlockPistonBase.EXTENDED, Boolean.valueOf(true)), 2);
                return false;
            }
        ...
        if (eventID == 0) {
            ...
            worldIn.setBlockState(pos, Blocks.piston_extension.getDefaultState().withProperty(BlockPistonMoving.field_176426_a, var6).withProperty(BlockPistonMoving.field_176425_b, isSticky ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT), 3);
            worldIn.setTileEntity(pos, BlockPistonMoving.func_176423_a(getStateFromMeta(eventParam), var6, false, true));
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos) {
        ...
        if (var3.getBlock() == this && ((Boolean) var3.getValue(BlockPistonBase.EXTENDED)).booleanValue()) {
            float var4 = 0.25F;
            EnumFacing var5 = (EnumFacing) var3.getValue(BlockPistonBase.FACING);
    ...
    private boolean func_176319_a(World worldIn, BlockPos p_176319_2_, EnumFacing p_176319_3_, boolean p_176319_4_) {
        ...
        if (!var5.func_177253_a()) {
            ...
            if (p_176319_4_) {
                BlockPistonExtension.EnumPistonType var17 = isSticky ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT;
                ...
                IBlockState var20 = Blocks.piston_extension.getDefaultState().withProperty(BlockPistonMoving.field_176426_a, p_176319_3_).withProperty(BlockPistonMoving.field_176425_b, isSticky ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT);
    ...
    public IBlockState getStateForEntityRender(IBlockState state) {
        return getDefaultState().withProperty(BlockPistonBase.FACING, EnumFacing.UP);
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(BlockPistonBase.FACING, BlockPistonBase.func_176317_b(meta)).withProperty(BlockPistonBase.EXTENDED, Boolean.valueOf((meta & 8) > 0));
    }
