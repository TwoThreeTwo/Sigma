...
public class BlockFire extends Block {
    ...
    protected BlockFire() {
        super(Material.fire);
        setDefaultState(blockState.getBaseState().withProperty(BlockFire.field_176543_a, Integer.valueOf(0)).withProperty(BlockFire.field_176540_b, Boolean.valueOf(false)).withProperty(BlockFire.field_176544_M, Boolean.valueOf(false)).withProperty(BlockFire.field_176545_N, Boolean.valueOf(false)).withProperty(BlockFire.field_176546_O, Boolean.valueOf(false)).withProperty(BlockFire.field_176541_P, Boolean.valueOf(false)).withProperty(BlockFire.field_176539_Q, Boolean.valueOf(false)).withProperty(BlockFire.field_176542_R, Integer.valueOf(0)));
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetDown()) && !Blocks.fire.func_176535_e(worldIn, pos.offsetDown())) {
            ...
            return state.withProperty(BlockFire.field_176545_N, Boolean.valueOf(func_176535_e(worldIn, pos.offsetNorth()))).withProperty(BlockFire.field_176546_O, Boolean.valueOf(func_176535_e(worldIn, pos.offsetEast()))).withProperty(BlockFire.field_176541_P, Boolean.valueOf(func_176535_e(worldIn, pos.offsetSouth()))).withProperty(BlockFire.field_176539_Q, Boolean.valueOf(func_176535_e(worldIn, pos.offsetWest()))).withProperty(BlockFire.field_176542_R, Integer.valueOf(var9)).withProperty(BlockFire.field_176540_b, Boolean.valueOf(var8)).withProperty(BlockFire.field_176544_M, Boolean.valueOf(var7));
        } else {
    ...
    public void func_180686_a(Block p_180686_1_, int p_180686_2_, int p_180686_3_) {
        field_149849_a.put(p_180686_1_, Integer.valueOf(p_180686_2_));
        field_149848_b.put(p_180686_1_, Integer.valueOf(p_180686_3_));
    }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (worldIn.getGameRules().getGameRuleBooleanValue("doFireTick")) {
            ...
            if (!var6 && worldIn.isRaining() && func_176537_d(worldIn, pos)) {
                ...
                int var7 = ((Integer) state.getValue(BlockFire.field_176543_a)).intValue();

                if (var7 < 15) {
                    state = state.withProperty(BlockFire.field_176543_a, Integer.valueOf(var7 + rand.nextInt(3) / 2));
                    ...
                    for (int var11 = -1; var11 <= 1; ++var11) {
                        for (int var12 = -1; var12 <= 4; ++var12) {
                            if (var10 != 0 || var12 != 0 || var11 != 0) {
                                ...
                                int var15 = func_176538_m(worldIn, var14);
                                ...
                                if (var15 > 0) {
                                    ...
                                    if (var16 > 0 && rand.nextInt(var13) <= var16 && (!worldIn.isRaining() || !func_176537_d(worldIn, var14))) {
                                        ...
                                        worldIn.setBlockState(var14, state.withProperty(BlockFire.field_176543_a, Integer.valueOf(var17)), 3);
                                    }
                                }
                            }
                        }
    ...
    private void func_176536_a(World worldIn, BlockPos p_176536_2_, int p_176536_3_, Random p_176536_4_, int p_176536_5_) {
        ...
        if (p_176536_4_.nextInt(p_176536_3_) < var6) {
            ...
            if (p_176536_4_.nextInt(p_176536_5_ + 10) < 5 && !worldIn.func_175727_C(p_176536_2_)) {
                ...
                worldIn.setBlockState(p_176536_2_, getDefaultState().withProperty(BlockFire.field_176543_a, Integer.valueOf(var8)), 3);
            } else {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(BlockFire.field_176543_a, Integer.valueOf(meta));
    }
    ...
    public int getMetaFromState(IBlockState state) {
        return ((Integer) state.getValue(BlockFire.field_176543_a)).intValue();
    }
