...
public class BlockSilverfish extends Block {
    ...
    public BlockSilverfish() {
        super(Material.clay);
        setDefaultState(blockState.getBaseState().withProperty(BlockSilverfish.VARIANT_PROP, BlockSilverfish.EnumType.STONE));
        setHardness(0.0F);
    ...
    protected ItemStack createStackedBlock(IBlockState state) {
        switch (BlockSilverfish.SwitchEnumType.field_180178_a[((BlockSilverfish.EnumType) state.getValue(BlockSilverfish.VARIANT_PROP)).ordinal()]) {
            case 1:
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(BlockSilverfish.VARIANT_PROP, BlockSilverfish.EnumType.func_176879_a(meta));
    }
    ...
    public int getMetaFromState(IBlockState state) {
        return ((BlockSilverfish.EnumType) state.getValue(BlockSilverfish.VARIANT_PROP)).func_176881_a();
    }
    ...
    public static enum EnumType implements IStringSerializable {
        ...
        private static final BlockSilverfish.EnumType[] field_176885_g = new BlockSilverfish.EnumType[EnumType.values().length];
        ...
        static {
            BlockSilverfish.EnumType[] var0 = EnumType.values();
            int var1 = var0.length;

            for (int var2 = 0; var2 < var1; ++var2) {
                BlockSilverfish.EnumType var3 = var0[var2];
                EnumType.field_176885_g[var3.func_176881_a()] = var3;
            }
        }
        ...
        public static BlockSilverfish.EnumType func_176878_a(IBlockState p_176878_0_) {
            BlockSilverfish.EnumType[] var1 = EnumType.values();
    ...
    static final class SwitchEnumType {
        ...
        static {
            try {
                SwitchEnumType.field_180178_a[BlockSilverfish.EnumType.COBBLESTONE.ordinal()] = 1;
            } catch (NoSuchFieldError var5) {
                ;
            }

            try {
                SwitchEnumType.field_180178_a[BlockSilverfish.EnumType.STONEBRICK.ordinal()] = 2;
            } catch (NoSuchFieldError var4) {
                ;
            }

            try {
                SwitchEnumType.field_180178_a[BlockSilverfish.EnumType.MOSSY_STONEBRICK.ordinal()] = 3;
            } catch (NoSuchFieldError var3) {
                ;
            }

            try {
                SwitchEnumType.field_180178_a[BlockSilverfish.EnumType.CRACKED_STONEBRICK.ordinal()] = 4;
            } catch (NoSuchFieldError var2) {
                ;
            }

            try {
                SwitchEnumType.field_180178_a[BlockSilverfish.EnumType.CHISELED_STONEBRICK.ordinal()] = 5;
