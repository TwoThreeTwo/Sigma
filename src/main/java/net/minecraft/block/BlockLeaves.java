...
public abstract class BlockLeaves extends BlockLeavesBase {
            ...
            for (int var9 = -var4; var9 <= var4; ++var9) {
                for (int var10 = -var4; var10 <= var4; ++var10) {
                    for (int var11 = -var4; var11 <= var4; ++var11) {
                        ...
                        if (var13.getBlock().getMaterial() == Material.leaves && !((Boolean) var13.getValue(BlockLeaves.field_176236_b)).booleanValue()) {
                            worldIn.setBlockState(var12, var13.withProperty(BlockLeaves.field_176236_b, Boolean.valueOf(true)), 4);
                        }
                    }
                }
            }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (!worldIn.isRemote) {
            if (((Boolean) state.getValue(BlockLeaves.field_176236_b)).booleanValue() && ((Boolean) state.getValue(BlockLeaves.field_176237_a)).booleanValue()) {
                byte var5 = 4;
                int var6 = var5 + 1;
                int var7 = pos.getX();
                int var8 = pos.getY();
                            ...
                            for (var15 = -var5; var15 <= var5; ++var15) {
                                ...
                                if (var16 != Blocks.log && var16 != Blocks.log2) {
                                    if (var16.getMaterial() == Material.leaves) {
                                        field_150128_a[(var13 + var12) * var11 + (var14 + var12) * var10 + var15 + var12] = -2;
                                    } else {
                                        field_150128_a[(var13 + var12) * var11 + (var14 + var12) * var10 + var15 + var12] = -1;
                                    }
                                } else {
                                    field_150128_a[(var13 + var12) * var11 + (var14 + var12) * var10 + var15 + var12] = 0;
                                }
                            }
                        }
                    }
                        ...
                        for (var14 = -var5; var14 <= var5; ++var14) {
                            for (var15 = -var5; var15 <= var5; ++var15) {
                                for (int var17 = -var5; var17 <= var5; ++var17) {
                                    if (field_150128_a[(var14 + var12) * var11 + (var15 + var12) * var10 + var17 + var12] == var13 - 1) {
                                        if (field_150128_a[(var14 + var12 - 1) * var11 + (var15 + var12) * var10 + var17 + var12] == -2) {
                                            field_150128_a[(var14 + var12 - 1) * var11 + (var15 + var12) * var10 + var17 + var12] = var13;
                                        }
                                        ...
                                        if (field_150128_a[(var14 + var12) * var11 + (var15 + var12 - 1) * var10 + var17 + var12] == -2) {
                                            field_150128_a[(var14 + var12) * var11 + (var15 + var12 - 1) * var10 + var17 + var12] = var13;
                                        }
                                        ...
                                        if (field_150128_a[(var14 + var12) * var11 + (var15 + var12) * var10 + (var17 + var12 - 1)] == -2) {
                                            field_150128_a[(var14 + var12) * var11 + (var15 + var12) * var10 + (var17 + var12 - 1)] = var13;
                                        }
                ...
                if (var13 >= 0) {
                    worldIn.setBlockState(pos, state.withProperty(BlockLeaves.field_176236_b, Boolean.valueOf(false)), 4);
                } else {
    ...
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune) {
        if (!worldIn.isRemote) {
            ...
            if (worldIn.rand.nextInt(var6) == 0) {
                Item var7 = getItemDropped(state, worldIn.rand, fortune);
                Block.spawnAsEntity(worldIn, pos, new ItemStack(var7, 1, damageDropped(state)));
            }
