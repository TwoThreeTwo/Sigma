...
public class BlockTallGrass extends BlockBush implements IGrowable {
    ...
    protected BlockTallGrass() {
        super(Material.vine);
        setDefaultState(blockState.getBaseState().withProperty(BlockTallGrass.field_176497_a, BlockTallGrass.EnumType.DEAD_BUSH));
        float var1 = 0.4F;
    ...
    public int getRenderColor(IBlockState state) {
        if (state.getBlock() != this) {
            ...
            BlockTallGrass.EnumType var2 = (BlockTallGrass.EnumType) state.getValue(BlockTallGrass.field_176497_a);
    ...
    public void harvestBlock(World worldIn, EntityPlayer playerIn, BlockPos pos, IBlockState state, TileEntity te) {
        if (!worldIn.isRemote && playerIn.getCurrentEquippedItem() != null && playerIn.getCurrentEquippedItem().getItem() == Items.shears) {
            ...
            Block.spawnAsEntity(worldIn, pos, new ItemStack(Blocks.tallgrass, 1, ((BlockTallGrass.EnumType) state.getValue(BlockTallGrass.field_176497_a)).func_177044_a()));
        } else {
    ...
    public boolean isStillGrowing(World worldIn, BlockPos p_176473_2_, IBlockState p_176473_3_, boolean p_176473_4_) {
        return p_176473_3_.getValue(BlockTallGrass.field_176497_a) != BlockTallGrass.EnumType.DEAD_BUSH;
    }
    ...
    public void grow(World worldIn, Random p_176474_2_, BlockPos p_176474_3_, IBlockState p_176474_4_) {
        ...
        if (p_176474_4_.getValue(BlockTallGrass.field_176497_a) == BlockTallGrass.EnumType.FERN) {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(BlockTallGrass.field_176497_a, BlockTallGrass.EnumType.func_177045_a(meta));
    }
    ...
    public int getMetaFromState(IBlockState state) {
        return ((BlockTallGrass.EnumType) state.getValue(BlockTallGrass.field_176497_a)).func_177044_a();
    }
    ...
    public static enum EnumType implements IStringSerializable {
        ...
        private static final BlockTallGrass.EnumType[] field_177048_d = new BlockTallGrass.EnumType[EnumType.values().length];
        ...
        static {
            BlockTallGrass.EnumType[] var0 = EnumType.values();
            int var1 = var0.length;

            for (int var2 = 0; var2 < var1; ++var2) {
                BlockTallGrass.EnumType var3 = var0[var2];
                EnumType.field_177048_d[var3.func_177044_a()] = var3;
            }
        }
