...
public class BlockTripWireHook extends Block {
    ...
    public BlockTripWireHook() {
        ...
        setDefaultState(blockState.getBaseState().withProperty(BlockTripWireHook.field_176264_a, EnumFacing.NORTH).withProperty(BlockTripWireHook.field_176263_b, Boolean.valueOf(false)).withProperty(BlockTripWireHook.field_176265_M, Boolean.valueOf(false)).withProperty(BlockTripWireHook.field_176266_N, Boolean.valueOf(false)));
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        return state.withProperty(BlockTripWireHook.field_176266_N, Boolean.valueOf(!World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetDown())));
    }
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        IBlockState var9 = getDefaultState().withProperty(BlockTripWireHook.field_176263_b, Boolean.valueOf(false)).withProperty(BlockTripWireHook.field_176265_M, Boolean.valueOf(false)).withProperty(BlockTripWireHook.field_176266_N, Boolean.valueOf(false));
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock) {
        if (neighborBlock != this) {
            if (func_176261_e(worldIn, pos, state)) {
                EnumFacing var5 = (EnumFacing) state.getValue(BlockTripWireHook.field_176264_a);
    ...
    public void func_176260_a(World worldIn, BlockPos p_176260_2_, IBlockState p_176260_3_, boolean p_176260_4_, boolean p_176260_5_, int p_176260_6_, IBlockState p_176260_7_) {
        EnumFacing var8 = (EnumFacing) p_176260_3_.getValue(BlockTripWireHook.field_176264_a);
        boolean var9 = ((Boolean) p_176260_3_.getValue(BlockTripWireHook.field_176265_M)).booleanValue();
        boolean var10 = ((Boolean) p_176260_3_.getValue(BlockTripWireHook.field_176263_b)).booleanValue();
        ...
        var12 &= var14 > 1;
        var13 &= var12;
        IBlockState var22 = getDefaultState().withProperty(BlockTripWireHook.field_176265_M, Boolean.valueOf(var12)).withProperty(BlockTripWireHook.field_176263_b, Boolean.valueOf(var13));

        if (var14 > 0) {
            var17 = p_176260_2_.offset(var8, var14);
            EnumFacing var24 = var8.getOpposite();
            worldIn.setBlockState(var17, var22.withProperty(BlockTripWireHook.field_176264_a, var24), 3);
        ...
        if (var9 != var12) {
            for (int var23 = 1; var23 < var14; ++var23) {
                ...
                if (var26 != null && worldIn.getBlockState(var25).getBlock() != Blocks.air) {
                    worldIn.setBlockState(var25, var26.withProperty(BlockTripWireHook.field_176265_M, Boolean.valueOf(var12)), 3);
                }
            }
        }
    }
    ...
    private void func_180694_a(World worldIn, BlockPos p_180694_2_, boolean p_180694_3_, boolean p_180694_4_, boolean p_180694_5_, boolean p_180694_6_) {
        if (p_180694_4_ && !p_180694_6_) {
            ...
            worldIn.playSoundEffect(p_180694_2_.getX() + 0.5D, p_180694_2_.getY() + 0.1D, p_180694_2_.getZ() + 0.5D, "random.bowhit", 0.4F, 1.2F / (worldIn.rand.nextFloat() * 0.2F + 0.9F));
        }
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos) {
        ...
        switch (BlockTripWireHook.SwitchEnumFacing.field_177056_a[((EnumFacing) access.getBlockState(pos).getValue(BlockTripWireHook.field_176264_a)).ordinal()]) {
            case 1:
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        boolean var4 = ((Boolean) state.getValue(BlockTripWireHook.field_176265_M)).booleanValue();
        boolean var5 = ((Boolean) state.getValue(BlockTripWireHook.field_176263_b)).booleanValue();
    ...
    public int isProvidingWeakPower(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing side) {
        return ((Boolean) state.getValue(BlockTripWireHook.field_176263_b)).booleanValue() ? 15 : 0;
    }

    @Override
    public int isProvidingStrongPower(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing side) {
        return !((Boolean) state.getValue(BlockTripWireHook.field_176263_b)).booleanValue() ? 0 : (state.getValue(BlockTripWireHook.field_176264_a) == side ? 15 : 0);
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(BlockTripWireHook.field_176264_a, EnumFacing.getHorizontal(meta & 3)).withProperty(BlockTripWireHook.field_176263_b, Boolean.valueOf((meta & 8) > 0)).withProperty(BlockTripWireHook.field_176265_M, Boolean.valueOf((meta & 4) > 0));
    }
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        if (((Boolean) state.getValue(BlockTripWireHook.field_176263_b)).booleanValue()) {
            var3 |= 8;
        }

        if (((Boolean) state.getValue(BlockTripWireHook.field_176265_M)).booleanValue()) {
            var3 |= 4;
        }
