...
public class BlockNewLog extends BlockLog {
    ...
    public BlockNewLog() {
        setDefaultState(blockState.getBaseState().withProperty(BlockNewLog.field_176300_b, BlockPlanks.EnumType.ACACIA).withProperty(BlockLog.AXIS_PROP, BlockLog.EnumAxis.Y));
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        IBlockState var2 = getDefaultState().withProperty(BlockNewLog.field_176300_b, BlockPlanks.EnumType.func_176837_a((meta & 3) + 4));
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        switch (BlockNewLog.SwitchEnumAxis.field_180191_a[((BlockLog.EnumAxis) state.getValue(BlockLog.AXIS_PROP)).ordinal()]) {
            case 1:
                var3 |= 4;
                break;
