...
public abstract class BlockFlower extends BlockBush {
    ...
    protected BlockFlower() {
        ...
        setDefaultState(blockState.getBaseState().withProperty(func_176494_l(), func_176495_j() == BlockFlower.EnumFlowerColor.RED ? BlockFlower.EnumFlowerType.POPPY : BlockFlower.EnumFlowerType.DANDELION));
    }
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List list) {
        BlockFlower.EnumFlowerType[] var4 = BlockFlower.EnumFlowerType.func_176966_a(func_176495_j());
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(func_176494_l(), BlockFlower.EnumFlowerType.func_176967_a(func_176495_j(), meta));
    }
    ...
    public static enum EnumFlowerType implements IStringSerializable {
        ...
        static {
            ...
            for (int var2 = 0; var2 < var1; ++var2) {
                ...
                Collection var4 = Collections2.filter(Lists.newArrayList(EnumFlowerType.values()), new Predicate() {
                ...
                EnumFlowerType.field_176981_k[var3.ordinal()] = (BlockFlower.EnumFlowerType[]) var4.toArray(new BlockFlower.EnumFlowerType[var4.size()]);
            }
        }
        ...
        public static BlockFlower.EnumFlowerType func_176967_a(BlockFlower.EnumFlowerColor p_176967_0_, int p_176967_1_) {
            BlockFlower.EnumFlowerType[] var2 = EnumFlowerType.field_176981_k[p_176967_0_.ordinal()];
