...
public abstract class BlockRailBase extends Block {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos) {
        ...
        BlockRailBase.EnumRailDirection var4 = var3.getBlock() == this ? (BlockRailBase.EnumRailDirection) var3.getValue(func_176560_l()) : null;
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock) {
        if (!worldIn.isRemote) {
            BlockRailBase.EnumRailDirection var5 = (BlockRailBase.EnumRailDirection) state.getValue(func_176560_l());
            boolean var6 = false;
            ...
            if (var6) {
                ...
                func_176561_b(worldIn, pos, state, neighborBlock);
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (((BlockRailBase.EnumRailDirection) state.getValue(func_176560_l())).func_177018_c()) {
    ...
    public static enum EnumRailDirection implements IStringSerializable {
        NORTH_SOUTH("NORTH_SOUTH", 0, 0, "north_south"), EAST_WEST("EAST_WEST", 1, 1, "east_west"), ASCENDING_EAST("ASCENDING_EAST", 2, 2, "ascending_east"), ASCENDING_WEST("ASCENDING_WEST", 3, 3, "ascending_west"), ASCENDING_NORTH("ASCENDING_NORTH", 4, 4, "ascending_north"), ASCENDING_SOUTH("ASCENDING_SOUTH", 5, 5, "ascending_south"), SOUTH_EAST("SOUTH_EAST", 6, 6, "south_east"), SOUTH_WEST("SOUTH_WEST", 7, 7, "south_west"), NORTH_WEST("NORTH_WEST", 8, 8, "north_west"), NORTH_EAST("NORTH_EAST", 9, 9, "north_east");
        private static final BlockRailBase.EnumRailDirection[] field_177030_k = new BlockRailBase.EnumRailDirection[EnumRailDirection.values().length];
        ...
        static {
            BlockRailBase.EnumRailDirection[] var0 = EnumRailDirection.values();
            int var1 = var0.length;

            for (int var2 = 0; var2 < var1; ++var2) {
                BlockRailBase.EnumRailDirection var3 = var0[var2];
                EnumRailDirection.field_177030_k[var3.func_177015_a()] = var3;
            }
        }
        ...
        private EnumRailDirection(String p_i45738_1_, int p_i45738_2_, int p_i45738_3_, String p_i45738_4_) {
            field_177027_l = p_i45738_3_;
            field_177028_m = p_i45738_4_;
        }
        ...
        public int func_177015_a() {
            return field_177027_l;
        }

        @Override
        public String toString() {
            return field_177028_m;
        }
    ...
    static final class SwitchEnumRailDirection {
        ...
        static {
            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.NORTH_SOUTH.ordinal()] = 1;
            } catch (NoSuchFieldError var10) {
                ;
            }

            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.EAST_WEST.ordinal()] = 2;
            } catch (NoSuchFieldError var9) {
                ;
            }

            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.ASCENDING_EAST.ordinal()] = 3;
            } catch (NoSuchFieldError var8) {
                ;
            }

            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.ASCENDING_WEST.ordinal()] = 4;
            } catch (NoSuchFieldError var7) {
                ;
            }

            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.ASCENDING_NORTH.ordinal()] = 5;
            } catch (NoSuchFieldError var6) {
                ;
            }

            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.ASCENDING_SOUTH.ordinal()] = 6;
            } catch (NoSuchFieldError var5) {
                ;
            }

            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.SOUTH_EAST.ordinal()] = 7;
            } catch (NoSuchFieldError var4) {
                ;
            }

            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.SOUTH_WEST.ordinal()] = 8;
            } catch (NoSuchFieldError var3) {
                ;
            }

            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.NORTH_WEST.ordinal()] = 9;
            } catch (NoSuchFieldError var2) {
                ;
            }

            try {
                SwitchEnumRailDirection.field_180371_a[BlockRailBase.EnumRailDirection.NORTH_EAST.ordinal()] = 10;
    ...
    public class Rail {
        ...
        public Rail(World worldIn, BlockPos p_i45739_3_, IBlockState p_i45739_4_) {
            field_150660_b = worldIn;
            field_180367_c = p_i45739_3_;
            field_180366_e = p_i45739_4_;
            field_180365_d = (BlockRailBase) p_i45739_4_.getBlock();
            BlockRailBase.EnumRailDirection var5 = (BlockRailBase.EnumRailDirection) p_i45739_4_.getValue(func_176560_l());
            field_150656_f = field_180365_d.isPowered;
            func_180360_a(var5);
        }
        ...
        private void func_180360_a(BlockRailBase.EnumRailDirection p_180360_1_) {
            ...
            switch (BlockRailBase.SwitchEnumRailDirection.field_180371_a[p_180360_1_.ordinal()]) {
                case 1:
                    field_150657_g.add(field_180367_c.offsetNorth());
                    field_150657_g.add(field_180367_c.offsetSouth());
                    break;

                case 2:
                    field_150657_g.add(field_180367_c.offsetWest());
                    field_150657_g.add(field_180367_c.offsetEast());
                    break;

                case 3:
                    field_150657_g.add(field_180367_c.offsetWest());
                    field_150657_g.add(field_180367_c.offsetEast().offsetUp());
                    break;

                case 4:
                    field_150657_g.add(field_180367_c.offsetWest().offsetUp());
                    field_150657_g.add(field_180367_c.offsetEast());
                    break;

                case 5:
                    field_150657_g.add(field_180367_c.offsetNorth().offsetUp());
                    field_150657_g.add(field_180367_c.offsetSouth());
                    break;

                case 6:
                    field_150657_g.add(field_180367_c.offsetNorth());
                    field_150657_g.add(field_180367_c.offsetSouth().offsetUp());
                    break;
        ...
        private void func_150651_b() {
            for (int var1 = 0; var1 < field_150657_g.size(); ++var1) {
                BlockRailBase.Rail var2 = func_180697_b((BlockPos) field_150657_g.get(var1));

                if (var2 != null && var2.func_150653_a(this)) {
                    field_150657_g.set(var1, var2.field_180367_c);
                } else {
        ...
        private boolean func_180359_a(BlockPos p_180359_1_) {
            return BlockRailBase.func_176562_d(field_150660_b, p_180359_1_) || BlockRailBase.func_176562_d(field_150660_b, p_180359_1_.offsetUp()) || BlockRailBase.func_176562_d(field_150660_b, p_180359_1_.offsetDown());
        }

        private BlockRailBase.Rail func_180697_b(BlockPos p_180697_1_) {
            IBlockState var3 = field_150660_b.getBlockState(p_180697_1_);

            if (BlockRailBase.func_176563_d(var3)) {
                return BlockRailBase.this.new Rail(field_150660_b, p_180697_1_, var3);
            } else {
                BlockPos var2 = p_180697_1_.offsetUp();
                var3 = field_150660_b.getBlockState(var2);

                if (BlockRailBase.func_176563_d(var3)) {
                    return BlockRailBase.this.new Rail(field_150660_b, var2, var3);
                } else {
                    var2 = p_180697_1_.offsetDown();
                    var3 = field_150660_b.getBlockState(var2);
                    return BlockRailBase.func_176563_d(var3) ? BlockRailBase.this.new Rail(field_150660_b, var2, var3) : null;
                }
            }
        }

        private boolean func_150653_a(BlockRailBase.Rail p_150653_1_) {
            return func_180363_c(p_150653_1_.field_180367_c);
        }

        private boolean func_180363_c(BlockPos p_180363_1_) {
            for (int var2 = 0; var2 < field_150657_g.size(); ++var2) {
                BlockPos var3 = (BlockPos) field_150657_g.get(var2);
        ...
        protected int countAdjacentRails() {
            ...
            while (var2.hasNext()) {
                ...
                if (func_180359_a(field_180367_c.offset(var3))) {
                    ++var1;
                }
            }
        ...
        private void func_150645_c(BlockRailBase.Rail p_150645_1_) {
            field_150657_g.add(p_150645_1_.field_180367_c);
            BlockPos var2 = field_180367_c.offsetNorth();
            BlockPos var3 = field_180367_c.offsetSouth();
            BlockPos var4 = field_180367_c.offsetWest();
            BlockPos var5 = field_180367_c.offsetEast();
            boolean var6 = func_180363_c(var2);
            boolean var7 = func_180363_c(var3);
            boolean var8 = func_180363_c(var4);
            boolean var9 = func_180363_c(var5);
            ...
            if (var10 == BlockRailBase.EnumRailDirection.NORTH_SOUTH) {
                if (BlockRailBase.func_176562_d(field_150660_b, var2.offsetUp())) {
                    var10 = BlockRailBase.EnumRailDirection.ASCENDING_NORTH;
                }

                if (BlockRailBase.func_176562_d(field_150660_b, var3.offsetUp())) {
                    var10 = BlockRailBase.EnumRailDirection.ASCENDING_SOUTH;
                }
            }

            if (var10 == BlockRailBase.EnumRailDirection.EAST_WEST) {
                if (BlockRailBase.func_176562_d(field_150660_b, var5.offsetUp())) {
                    var10 = BlockRailBase.EnumRailDirection.ASCENDING_EAST;
                }

                if (BlockRailBase.func_176562_d(field_150660_b, var4.offsetUp())) {
            ...
            field_180366_e = field_180366_e.withProperty(field_180365_d.func_176560_l(), var10);
            field_150660_b.setBlockState(field_180367_c, field_180366_e, 3);
        }

        private boolean func_180361_d(BlockPos p_180361_1_) {
            BlockRailBase.Rail var2 = func_180697_b(p_180361_1_);
        ...
        public BlockRailBase.Rail func_180364_a(boolean p_180364_1_, boolean p_180364_2_) {
            BlockPos var3 = field_180367_c.offsetNorth();
            BlockPos var4 = field_180367_c.offsetSouth();
            BlockPos var5 = field_180367_c.offsetWest();
            BlockPos var6 = field_180367_c.offsetEast();
            boolean var7 = func_180361_d(var3);
            boolean var8 = func_180361_d(var4);
            boolean var9 = func_180361_d(var5);
            boolean var10 = func_180361_d(var6);
            ...
            if (var11 == BlockRailBase.EnumRailDirection.EAST_WEST) {
                if (BlockRailBase.func_176562_d(field_150660_b, var6.offsetUp())) {
            ...
            func_180360_a(var11);
            field_180366_e = field_180366_e.withProperty(field_180365_d.func_176560_l(), var11);

            if (p_180364_2_ || field_150660_b.getBlockState(field_180367_c) != field_180366_e) {
                field_150660_b.setBlockState(field_180367_c, field_180366_e, 3);

                for (int var12 = 0; var12 < field_150657_g.size(); ++var12) {
                    BlockRailBase.Rail var13 = func_180697_b((BlockPos) field_150657_g.get(var12));
