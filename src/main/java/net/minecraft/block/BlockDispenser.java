...
public class BlockDispenser extends BlockContainer {
    ...
    public static IPosition getDispensePosition(IBlockSource coords) {
        ...
        double var2 = coords.getX() + 0.7D * var1.getFrontOffsetX();
        double var4 = coords.getY() + 0.7D * var1.getFrontOffsetY();
        double var6 = coords.getZ() + 0.7D * var1.getFrontOffsetZ();
    ...
    private void setDefaultDirection(World worldIn, BlockPos pos, IBlockState state) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, state.withProperty(BlockDispenser.FACING, var4).withProperty(BlockDispenser.TRIGGERED, Boolean.valueOf(false)), 2);
        }
    }
    ...
    protected void func_176439_d(World worldIn, BlockPos p_176439_2_) {
        ...
        if (var4 != null) {
            ...
            if (var5 < 0) {
                ...
                IBehaviorDispenseItem var7 = func_149940_a(var6);
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock) {
        ...
        boolean var6 = ((Boolean) state.getValue(BlockDispenser.TRIGGERED)).booleanValue();
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        return getDefaultState().withProperty(BlockDispenser.FACING, BlockPistonBase.func_180695_a(worldIn, pos, placer)).withProperty(BlockDispenser.TRIGGERED, Boolean.valueOf(false));
    }
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        if (((Boolean) state.getValue(BlockDispenser.TRIGGERED)).booleanValue()) {
            var3 |= 8;
        }
