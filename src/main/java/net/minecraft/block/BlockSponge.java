...
public class BlockSponge extends Block {
    ...
    protected BlockSponge() {
        ...
        setDefaultState(blockState.getBaseState().withProperty(BlockSponge.WET_PROP, Boolean.valueOf(false)));
    ...
    public int damageDropped(IBlockState state) {
        return ((Boolean) state.getValue(BlockSponge.WET_PROP)).booleanValue() ? 1 : 0;
    }
    ...
    protected void setWet(World worldIn, BlockPos p_176311_2_, IBlockState p_176311_3_) {
        if (!((Boolean) p_176311_3_.getValue(BlockSponge.WET_PROP)).booleanValue() && absorbWater(worldIn, p_176311_2_)) {
            worldIn.setBlockState(p_176311_2_, p_176311_3_.withProperty(BlockSponge.WET_PROP, Boolean.valueOf(true)), 2);
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(BlockSponge.WET_PROP, Boolean.valueOf((meta & 1) == 1));
    }
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (((Boolean) state.getValue(BlockSponge.WET_PROP)).booleanValue()) {
